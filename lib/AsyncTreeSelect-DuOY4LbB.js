import { defineComponent as Ie, provide as ht, computed as N, inject as yt, shallowRef as H, createVNode as _, getCurrentInstance as Dn, reactive as Yt, onMounted as Jt, onUpdated as Pn, ref as Pe, watchEffect as De, watch as we, nextTick as pt, onBeforeUnmount as Tn, Transition as In, withDirectives as $n, vShow as Ln, Fragment as An, toRaw as xe, onUnmounted as _n, cloneVNode as Fn, toRef as Ge, toRefs as Vn, openBlock as Mn, createBlock as jn, unref as Bn, mergeProps as Hn } from "vue";
import { P as me, Y as ie, _ as w, h as re, g as Oe, a1 as Qt, aa as Zt, ab as Rn, $ as Wn, k as gt, I as at, L as zn, n as Un, m as mt, r as Gn, ac as Et, U as qn, i as Xn, A as lt, u as Yn, F as Jn, c as Qn, ad as Zn, d as ea, ae as ta, e as na, s as rt, b as aa, E as oa, G as la, f as it } from "./index-DGUz0BTe.js";
import { u as ra } from "./move-C7FDUX8Z.js";
import { K as be } from "./KeyCode-n3eOOGSl.js";
import { o as Ye } from "./omit-COyW2GJT.js";
import { L as ia, u as sa, a as ca, b as da, c as ua, t as Ot, B as fa, d as va, e as ha, g as ya } from "./index-DJfLjw5f.js";
import { p as en } from "./pickAttrs-BR2EV0Wa.js";
import { e as Ee } from "./eagerComputed-B06AqR4q.js";
import { u as Dt } from "./useMergedState-6HyZ0xMy.js";
import { g as pa, a as ga } from "./statusUtils-FU9aJEap.js";
import { g as ma } from "./index-BoNm47Nd.js";
...
const Pt = "open", Tt = "close", Ka = "---", It = Ie({
  ...
  setup(e, t) {
    ...
    const r = H(!1), l = bt(), {
      ...
      dropPosition: x,
      keyEntities: p
    })), C = Ee(() => k.value.expanded), I = Ee(() => k.value.selected), T = Ee(() => k.value.checked), $ = Ee(() => k.value.loaded), S = Ee(() => k.value.loading), M = Ee(() => k.value.halfChecked), B = Ee(() => k.value.dragOver), L = Ee(() => k.value.dragOverGapTop), F = Ee(() => k.value.dragOverGapBottom), Z = Ee(() => k.value.pos), J = H(), ae = N(() => {
      const {
        eventKey: c
      } = e, {
        keyEntities: y
    ...
    const se = (c) => {
      ...
      return typeof te == "function" ? te(Q.value) : te;
    }, Ke = () => {
      const {
        loadData: c,
        onNodeLoad: y
    ...
    const Ue = () => {
      ...
      if (A) {
        ...
        }, [typeof ye == "function" ? ye(Q.value) : ye]) : D();
      } else
        E && S.value && (W = D());
      let X;
      typeof g == "function" ? X = g(Q.value) : X = g, X = X === void 0 ? Ka : X;
      const Y = _("span", {
        class: `${K}-title`
      }, [X]);
      return _("span", {
    ...
    return () => {
      const c = w(w({}, e), n), {
        ...
        dropTargetKey: W,
        draggingNodeKey: X
      } = l.value, Y = ce.value, ye = en(A, {
        aria: !0,
        data: !0
      }), {
        level: Ce
      } = R[y] || {}, ke = G[G.length - 1], pe = _e(), Ve = !Y && pe, Qe = X === y, ot = K !== void 0 ? {
        "aria-selected": !!K
      } : void 0;
      return _("div", re(re({
        ref: te,
...
function $t(e, t, n, a, o, r, l, s, u, i) {
  ...
  let C = s[n.eventKey];
  if (m < b + x / 2) {
    const Z = l.findIndex((oe) => oe.key === C.key), J = Z <= 0 ? 0 : Z - 1, ae = l[J].key;
    C = s[ae];
  }
  const I = C.key, T = C, $ = C.key;
  let S = 0, M = 0;
  if (!u.has(I))
    for (let Z = 0; Z < k && Oa(C); Z += 1)
      C = C.parent, M += 1;
...
function Ta(e) {
  function t() {
    ...
    return Qt(n).map((o) => {
      ...
      for (const [Z, J] of Object.entries(o.props))
        v[Zt(Z)] = J;
      const {
        isLeaf: m,
        checkable: b,
      ...
      if (S.key !== null) {
        ...
        if (S.add) {
          const F = $.findIndex((ae) => {
            ...
            return oe === S.key;
          }), Z = Bt(Ft($, I, S.key), M, B, L), J = $.slice();
          J.splice(F + 1, 0, jt), u.value = J, i.value = Z, d.value = "show";
        } else {
          const F = I.findIndex((ae) => {
            ...
            return oe === S.key;
          }), Z = Bt(Ft(I, $, S.key), M, B, L), J = I.slice();
          J.splice(F + 1, 0, jt), u.value = J, i.value = Z, d.value = "hide";
        }
      } else
        $ !== I && (u.value = I);
...
const Ra = 10, Wa = Ie({
  ...
  setup(e, t) {
    ...
    const Z = N(() => ({
      ...
      keyEntities: C.value
    })), J = N(() => new Set(b.value)), ae = N(() => new Set(u.value)), oe = N(() => new Set(v.value)), fe = N(() => new Set(m.value)), ce = N(() => new Set(i.value)), ge = N(() => new Set(d.value));
    De(() => {
      if (k.value) {
        const f = rn(k.value, {
          fieldNames: S.value
    ...
    const Q = H([]);
    De(() => {
      Q.value = Ia(k.value, b.value, S.value);
    }), De(() => {
    ...
    const he = (f) => {
      ...
      const {
        ...
        dropAllowed: Ce,
        dragOverNodeKey: ke
      } = $t(f, L, h, s.value, B, A, Q.value, C.value, J.value, P);
      if (
      ...
      const {
        ...
        dropTargetPos: X,
        dragOverNodeKey: Y
      } = $t(f, L, h, s.value, B, K, Q.value, C.value, J.value, A);
      ...
      const {
        expanded: g,
        key: K
      } = h, A = Q.value.filter((E) => E.key === K)[0], P = nt(w(w({}, tt(K, Z.value)), {
        data: A.data
      }));
    ...
    }, O = N(() => T.value === null ? null : Q.value.find((f) => {
      let {
        key: h
      } = f;
      return h === T.value;
    }) || null), V = (f) => {
      let h = Q.value.findIndex((K) => {
        let {
          key: A
        } = K;
        return A === T.value;
      });
      h === -1 && f < 0 && (h = Q.value.length), h = (h + f + Q.value.length) % Q.value.length;
      const g = Q.value[h];
      if (g) {
        const {
          key: K
      ...
      if (A && A.data) {
        ...
        switch (f.which) {
          case be.LEFT: {
            P && J.value.has(T.value) ? j({}, E) : A.parent && y(A.parent.key), f.preventDefault();
            break;
          }
          case be.RIGHT: {
            P && !J.value.has(T.value) ? j({}, E) : A.children && A.children.length && y(A.children[0].key), f.preventDefault();
            break;
          }
          case be.ENTER:
          case be.SPACE: {
    ...
    return o({
      ...
      let Ze;
      return ke ? typeof ke == "object" ? Ze = ke : typeof ke == "function" ? Ze = {
        nodeDraggable: ke
      } : Ze = {} : Ze = !1, _(ba, {
        value: {
          prefixCls: E,
...
xt.inheritAttrs = !1;
var Ja = { icon: { tag: "svg", attrs: { viewBox: "0 0 1024 1024", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M840.4 300H183.6c-19.7 0-30.7 20.8-18.5 35l328.4 380.8c9.4 10.9 27.5 10.9 37 0L858.9 335c12.2-14.2 1.2-35-18.5-35z" } }] }, name: "caret-down", theme: "filled" };
function Ut(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] != null ? Object(arguments[t]) : {}, a = Object.keys(n);
    typeof Object.getOwnPropertySymbols == "function" && (a = a.concat(Object.getOwnPropertySymbols(n).filter(function(o) {
...
const uo = {
  ...
  setup(e, t) {
    ...
    const x = N(() => r.treeExpandedKeys ? r.treeExpandedKeys.slice() : o.searchValue ? b.value : m.value), p = (S) => {
      ...
      Z && ut(B) || ((L = l.onSelect) === null || L === void 0 || L.call(l, B.key, {
        selected: !J.includes(B.key)
    ...
    return a({
      ...
      const {
        ...
        searchValue: L,
        open: F,
        notFoundContent: Z = (S = n.notFoundContent) === null || S === void 0 ? void 0 : S.call(n)
      } = o, {
        listHeight: J,
        listItemHeight: ae,
        virtual: oe,
...
const Je = () => null;
Je.inheritAttrs = !1;
Je.displayName = "ATreeSelectNode";
Je.isTreeSelectNode = !0;
var ho = function(e, t) {
  var n = {};
  for (var a in e)
    Object.prototype.hasOwnProperty.call(e, a) && t.indexOf(a) < 0 && (n[a] = e[a]);
...
function go(e, t, n, a, o, r) {
  ...
  function u() {
    function i(d) {
      ...
      return d.map((b, x) => {
        const p = `${v}-${x}`, k = b[r.value], C = n.includes(k), I = i(b[r.children] || [], p, C), T = _(Je, b, {
          default: () => [I.map(($) => $.node)]
        });
        if (t === k && (l = T), C) {
          const $ = {
...
const No = Ie({
  ...
  setup(e, t) {
    ...
    const J = N(() => F.value.map((D) => D.value)), {
      maxLevel: ae,
      levelEntities: oe
    } = cn(p), [fe, ce] = ko(F, Z, l, p, ae, oe), ge = N(() => {
      ...
      if (B(c), e.autoClearSearchValue && m(""), e.onChange) {
        ...
        if (e.treeCheckStrictly) {
          const K = Z.value.filter((A) => !y.includes(A.value));
          G = [...G, ...K];
        }
        const te = S(G), f = {
      ...
      if (!i.value)
        ...
        let K = U ? [...J.value, g] : fe.value.filter((A) => A !== g);
        if (l.value) {
          const {
            missingRawValues: A,
            existRawValues: P
...
const ct = Ie({
  ...
  setup(e, t) {
    ...
    const l = Yn(), s = Jn.useInject(), u = N(() => pa(s.status, e.status)), {
      prefixCls: i,
      renderEmpty: d,
      direction: v,
      virtual: m,
    ...
    } = Zn(i, v), $ = N(() => I.value || x.value), S = ea(), M = N(() => {
      var z;
      return (z = C.value) !== null && z !== void 0 ? z : S.value;
    }), B = N(() => k()), L = N(() => e.placement !== void 0 ? e.placement : v.value === "rtl" ? "bottomRight" : "bottomLeft"), F = N(() => qt(B.value, ta(L.value), e.transitionName)), Z = N(() => qt(B.value, "", e.choiceTransitionName)), J = N(() => k("select-tree", e.prefixCls)), ae = N(() => k("tree-select", e.prefixCls)), [oe, fe] = ha(i), [ce] = Oo(ae, J), ge = N(() => Oe(e.popupClassName || e.dropdownClassName, `${ae.value}-dropdown`, {
      [`${ae.value}-dropdown-rtl`]: v.value === "rtl"
    }, fe.value)), de = N(() => !!(e.treeCheckable || e.multiple)), Q = N(() => e.showArrow !== void 0 ? e.showArrow : e.loading || !de.value), ue = Pe();
    o({
      focus() {
        var z, ne;
    ...
    return () => {
      ...
      return e.treeData === void 0 && a.default && (O.children = na(a.default())), oe(ce(_(No, re(re(re(re({}, n), c), {}, {
        ...
        removeIcon: D,
        clearIcon: j,
        switcherIcon: (V) => Za(J.value, Ae, V, a.leafIcon, Le),
        showTreeIcon: $e,
        notFoundContent: U,
