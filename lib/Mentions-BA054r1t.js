import { defineComponent as A, inject as be, shallowRef as K, onBeforeUnmount as Se, createVNode as h, computed as j, ref as X, reactive as Ce, watchEffect as ye, provide as we, toRef as ee, onUpdated as Pe, nextTick as Oe, watch as Ie, openBlock as te, createBlock as Me, unref as Te, normalizeProps as Fe, guardReactiveProps as Ee, withCtx as $e, createElementBlock as Ne, Fragment as Be, renderList as _e, renderSlot as je } from "vue";
import { b8 as Ae, b9 as Y, ba as ue, aN as Le, M as Re, P as _, a7 as De, d as c, i as ce, O as de, h as J, bb as ze, j as U, K as I, $ as He, G as Ve, g as We, aR as Ke, r as ne, aV as ke, bc as Ue, bd as Xe, aT as Ye, be as Ge, af as qe, z as Je, ak as oe, u as Qe, f as Ze, aC as et, aD as tt, bf as nt, l as ot, aI as ae, bg as at } from "./index--A0P2N-L.js";
function it(e) {
  const {
    selectionStart: o
  } = e;
  ...
  setup(e, o) {
    ...
    const b = (l) => {
      ...
      if ([I.ESC, I.UP, I.DOWN, I.ENTER].indexOf(r) === -1)
        if ($ !== -1) {
          const O = D.slice($ + N.length), z = V(O, e), W = !!k(O).length;
...
const yt = function() {
  ...
  setup(e, o) {
    ...
    var s, u, p;
    process.env.NODE_ENV !== "production" && Je(!oe(((s = n.default) === null || s === void 0 ? void 0 : s.call(n)) || []).length, "Mentions", "`Mentions.Option` is deprecated. Please use `options` instead.");
    const {
      prefixCls: a,
      renderEmpty: b,
      direction: M
    } = Qe("mentions", e), [S, v] = St(a), x = K(!1), C = K(null), y = K((p = (u = e.value) !== null && u !== void 0 ? u : e.defaultValue) !== null && p !== void 0 ? p : ""), w = Ze(), T = et.useInject(), B = j(() => tt(T.status, e.status));
    nt({
    ...
    return () => {
      ...
      return S(E ? h("div", {
        class: J(`${a.value}-affix-wrapper`, ae(`${a.value}-affix-wrapper`, B.value, E), $, v.value)
      }, [Z, h("span", {
  ...
  setup(e) {
    return (o, n) => (te(), Me(Te(Pt), Fe(Ee(o.$attrs)), {
      default: $e(() => [
        (te(!0), Ne(Be, null, _e(o.$slots, (t, i) => je(o.$slots, i, { key: i })), 128))
      ]),
      _: 3
    }, 16));
  }
