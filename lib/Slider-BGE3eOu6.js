...
import { _ as f, g as j, w as de, n as Ee, h as T, o as ce, P as g, p as G, K as N, B as q, k as he, q as De, t as Y, v as Re, x as je, T as ze, y as te, i as Ae, m as Ie, z as _e, r as We, j as Ge, A as Ue, c as Ke, u as Xe, C as D, b as E, D as Ye, s as qe, f as A } from "./index-D4pR5m6G.js";
const J = (e, s) => {
  let {
    attrs: t
  } = s;
...
const Je = (e, s, t, n, o, a) => {
  ...
  const {
    ...
    dotStyle: y,
    activeDotStyle: M
  } = t, h = b - C, S = Je(o, r, i, l, C, b).map((c) => {
...
const et = z({
  ...
  methods: {
    ...
    renderSlider() {
      ...
      } = this, S = u || d, c = s.map((x) => this.calcOffset(x)), $ = `${t}-handle`, B = s.map((x, v) => {
        let p = C[v] || 0;
        (a || C[v] === null) && (p = null);
        const V = e === v;
        return S({
...
const dt = (e) => typeof e == "number" ? e.toString() : "", ct = () => ({
  ...
  setup(e, s) {
    ...
    return () => {
      ...
      let k;
      return typeof V == "object" && (k = V.draggableTrack), m(V ? w(ot, T(T(T({}, t), P), {}, {
        step: P.step,
        draggableTrack: k,
        class: O,
        ref: y,
