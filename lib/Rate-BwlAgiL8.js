...
import { I as re, P as R, i as se, m as ie, _ as x, r as ce, j as ue, k as de, c as fe, u as ve, g as me, h as T, T as he, l as pe } from "./index-DGUz0BTe.js";
  ...
  setup(e, t) {
    ...
    return () => {
      const {
        ...
        class: F,
        style: H
      } = s, P = [], G = r ? `${h.value}-disabled` : "", W = e.character || a.character || (() => b(B, null, null));
      for (let $ = 0; $ < l; $++)
        P.push(b(xe, {
          ref: S($),
          key: $,
