import { I as tt, f as M, g as j, h as R, X as nt, y as Re, _ as v, b as B, D as Y, s as ye, i as rt, ak as at, r as Ae, b0 as it, u as lt, F as ot, c as st, ac as ut, d as dt, aZ as Ve, a_ as Te, ag as ct, P as be } from "./index-DELjRDde.js";
import { createVNode as b, defineComponent as Ie, ref as We, onBeforeUnmount as He, shallowRef as D, computed as W, watch as Z } from "vue";
import { i as ft, D as pt } from "./DownOutlined-CZVhYEaS.js";
import { K as le } from "./KeyCode-n3eOOGSl.js";
import { o as mt } from "./omit-CP-pNPup.js";
import { g as gt, a as Se } from "./statusUtils-CivWhTWh.js";
import { i as vt, a as Ge, g as ht, c as bt, f as St, d as $t, b as Le, e as Ue } from "./index-DjlcmUON.js";
...
class z {
  ...
  add(t) {
    ...
    const i = Math.max(Q(this.number), Q(n));
...
class U {
  constructor(t) {
    ...
    let n = t;
    if (Ce(n) && (n = Number(n)), n = typeof n == "string" ? n : Pe(n), De(n)) {
      const a = J(n);
...
const Be = (e, t) => e || t.isEmpty() ? t.toString() : t.toNumber(), ze = (e) => {
  ...
  setup(e, t) {
    ...
    const d = D(), p = D(!1), f = D(!1), c = D(!1), s = D(P(e.value));
    function $(r) {
      e.value === void 0 && (s.value = r);
    }
    const w = (r, o) => {
      if (!o)
        return e.precision >= 0 ? e.precision : Math.max(Q(r), Q(e.step));
    }, I = (r) => {
      const o = String(r);
      if (e.parser)
        return e.parser(o);
    ...
    const y = W(() => ze(e.max)), N = W(() => ze(e.min)), A = W(() => !y.value || !s.value || s.value.isInvalidate() ? !1 : y.value.lessEquals(s.value)), V = W(() => !N.value || !s.value || s.value.isInvalidate() ? !1 : s.value.lessEquals(N.value)), [q, ee] = Et(d, p), oe = (r) => y.value && !r.lessEquals(y.value) ? y.value : N.value && !N.value.lessEquals(r) ? N.value : null, te = (r) => !oe(r), k = (r, o) => {
      ...
      if (!m.isEmpty() && !o && (m = oe(m) || m, x = !0), !e.readonly && !e.disabled && x) {
        ...
        return G >= 0 && (m = P(xe(_, ".", G))), m.equals(s.value) || ($(m), (u = e.onChange) === null || u === void 0 || u.call(e, m.isEmpty() ? null : Be(e.stringMode, m)), e.value === void 0 && O(m, o)), m;
      }
      return s.value;
    }, se = Ct(), h = (r) => {
      var o;
      ...
      const o = P(I(S.value));
      let u = o;
      o.isNaN() ? u = s.value : u = k(o, r), e.value !== void 0 ? O(s.value, !1) : u.isNaN() || O(u, !1);
    }, ue = (r) => {
      var o;
      const {
        which: u
    ...
    return Z(() => e.precision, () => {
      s.value.isInvalidate() || O(s.value, !1);
    }, {
      flush: "post"
    }), Z(() => e.value, () => {
      const r = P(e.value);
      s.value = r;
      const o = P(I(S.value));
      (!r.equals(o) || !f.value || e.formatter) && O(r, f.value);
    }, {
      flush: "post"
    }), Z(S, () => {
      e.formatter && ee();
      ...
      const r = v(v({}, n), e), {
        ...
        class: Ke,
        style: Ye
      } = r, Ze = Pt(r, ["prefixCls", "min", "max", "step", "defaultValue", "value", "disabled", "readonly", "keyboard", "controls", "autofocus", "stringMode", "parser", "formatter", "precision", "decimalSeparator", "onChange", "onInput", "onPressEnter", "onStep", "lazy", "class", "style"]), {
        upHandler: Je,
        downHandler: Qe
      } = a, Me = `${o}-input`, he = {};
      return Xe ? he.onChange = H : he.onInput = H, b("div", {
        class: j(o, Ke, {
          [`${o}-focused`]: p.value,
          [`${o}-disabled`]: ae,
          [`${o}-readonly`]: ie,
...
const je = ke(), At = () => v(v({}, je), {
  ...
  setup(e, t) {
    ...
    }), [O, y] = Mt(c), N = W(() => I.value || s.value), A = D(e.value === void 0 ? e.defaultValue : e.value), V = D(!1);
    Z(() => e.value, () => {
      A.value = e.value;
    });
    const q = D(null), ee = () => {
    ...
    return () => {
      ...
      const {
        ...
        readonly: u,
        style: m,
        addonBefore: x = (X = l.addonBefore) === null || X === void 0 ? void 0 : X.call(l),
        addonAfter: _ = (K = l.addonAfter) === null || K === void 0 ? void 0 : K.call(l),
      ...
      let F = b(Dt, R(R({}, mt(ie, ["size", "defaultValue"])), {}, {
        ref: q,
        lazy: !!ae.lazy,
        value: A.value,
        class: ce,
