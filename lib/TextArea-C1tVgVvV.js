import { a1 as ce, _ as x, P as $, s as ze, as as le, J as Ae, R as F, F as fe, ah as re, g as W, V as Ie, y as K, w as Re, h as j, u as Te, c as Fe, d as Be } from "./index-DGUz0BTe.js";
import { defineComponent as ne, createVNode as I, ref as B, onBeforeUnmount as ie, watchEffect as ve, computed as k, watch as te, getCurrentInstance as ge, shallowRef as N, nextTick as ue } from "vue";
import { a as me, g as pe } from "./statusUtils-FU9aJEap.js";
import { R as $e } from "./index-BPMFHqJ9.js";
import { o as Y } from "./omit-COyW2GJT.js";
import { B as Ee } from "./BaseInput-CNspKwab.js";
import { u as Pe } from "./index-CrosLSpq.js";
const D = (e) => e != null && (Array.isArray(e) ? ce(e).length : !0);
function tt(e) {
  return D(e.prefix) || D(e.suffix) || D(e.allowClear);
}
function nt(e) {
  return D(e.addonBefore) || D(e.addonAfter);
}
function _e(e) {
...
`, Ke = ["letter-spacing", "line-height", "padding-top", "padding-bottom", "font-family", "font-weight", "font-size", "font-variant", "text-rendering", "text-transform", "width", "text-indent", "padding-left", "padding-right", "border-width", "box-sizing", "word-break", "white-space"], J = {};
let y;
function We(e) {
  ...
  setup(e, d) {
    ...
    const V = () => {
      const {
        prefixCls: f,
        disabled: O
      } = e, M = Y(e, ["prefixCls", "onPressEnter", "autoSize", "autosize", "defaultValue", "allowClear", "type", "maxlength", "valueModifiers"]), H = W(f, n.class, {
        [`${f}-disabled`]: O
      }), Z = h.value ? w.value : null, _ = [n.style, s.value, Z], T = x(x(x({}, M), n), {
        style: _,
        class: H
      });
      return (a.value === q || a.value === Q) && _.push({
        overflowX: "hidden",
        overflowY: "hidden"
...
const at = ne({
  ...
  setup(e, d) {
    ...
    const g = Te(), m = fe.useInject(), u = k(() => pe(m.status, e.status)), s = N(e.value === void 0 ? e.defaultValue : e.value), a = N(), c = N(""), {
      prefixCls: r,
      size: p,
      direction: h
    } = Fe("input", e), [S, w] = Pe(r), E = Be(), C = k(() => e.showCount === "" || e.showCount || !1), A = k(() => Number(e.maxlength) > 0), R = N(!1), P = N(), V = N(0), f = (t) => {
      ...
      v !== c.value && (_(v), X(t.currentTarget, t, U, v)), o("compositionend", t);
    }, M = ge();
    te(() => e.value, () => {
      var t;
    ...
    const H = (t) => {
      var l;
      Ne((l = a.value) === null || l === void 0 ? void 0 : l.textArea, t);
    }, Z = () => {
      var t, l;
      ...
      return !((t = e.valueModifiers) === null || t === void 0) && t.lazy && delete b.onInput, I(Ze, j(j({}, b), {}, {
