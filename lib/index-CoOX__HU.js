import { e as tt, J as _, bC as nt, h as j, j as R, a5 as rt, x as Re, d as v, F as B, E as J, H as ye, K as ie, g as at, aR as lt, aS as it, r as Ae, aV as We, bc as He, aU as Ge, aT as ot, bd as st, bS as ut, be as dt, bT as ct, f as ft, aC as pt, aD as mt, u as gt, aE as vt, N as bt, aI as he, O as ht, bU as St, bV as Ve, bW as Te, aM as $t, P as Se } from "./index--A0P2N-L.js";
import { createVNode as h, defineComponent as Ie, ref as Ue, onBeforeUnmount as Le, shallowRef as P, computed as W, watch as Y } from "vue";
...
class L {
  ...
  add(t) {
    ...
    return new L(`${c.slice(0, -a)}.${c.slice(-a)}`);
  }
  isEmpty() {
    return this.empty;
  }
...
function xe(e, t, n) {
  ...
  if (n >= 0) {
    const c = Number(d[n]);
    if (c >= 5 && !a) {
      const s = O(e).add(`${l}0.${"0".repeat(n)}${10 - c}`);
...
const Be = (e, t) => e || t.isEmpty() ? t.toString() : t.toNumber(), ze = (e) => {
  ...
  stringMode: B(),
  defaultValue: J([String, Number]),
  value: J([String, Number]),
  prefixCls: ye(),
  min: J([String, Number]),
  max: J([String, Number]),
  step: J([String, Number], 1),
  tabindex: Number,
  controls: B(!0),
  readonly: B(),
  disabled: B(),
  ...
  setup(e, t) {
    ...
    const d = P(), p = P(!1), f = P(!1), c = P(!1), s = P(O(e.value));
    function $(r) {
    ...
    const w = (r, o) => {
      ...
      if (!o) {
        const m = w(u, o);
        if (Pe(u) && (e.decimalSeparator || m >= 0)) {
    ...
    const y = W(() => ze(e.max)), N = W(() => ze(e.min)), A = W(() => !y.value || !s.value || s.value.isInvalidate() ? !1 : y.value.lessEquals(s.value)), V = W(() => !N.value || !s.value || s.value.isInvalidate() ? !1 : s.value.lessEquals(N.value)), [q, ee] = Et(d, p), oe = (r) => y.value && !r.lessEquals(y.value) ? y.value : N.value && !N.value.lessEquals(r) ? N.value : null, te = (r) => !oe(r), k = (r, o) => {
      ...
      if (!m.isEmpty() && !o && (m = oe(m) || m, x = !0), !e.readonly && !e.disabled && x) {
        ...
        return G >= 0 && (m = O(xe(M, ".", G))), m.equals(s.value) || ($(m), (u = e.onChange) === null || u === void 0 || u.call(e, m.isEmpty() ? null : Be(e.stringMode, m)), e.value === void 0 && D(m, o)), m;
      }
      return s.value;
    }, se = Ct(), b = (r) => {
      var o;
      ...
      let m = O(e.step);
      r || (m = m.negate());
      const x = (s.value || O(0)).add(m.toString()), M = k(x, !1);
      (o = e.onStep) === null || o === void 0 || o.call(e, Be(e.stringMode, M), {
        offset: e.step,
        type: r ? "up" : "down"
    ...
    return Y(() => e.precision, () => {
      ...
      const r = v(v({}, n), e), {
        ...
        class: Xe,
        style: Je
      } = r, Ye = Ot(r, ["prefixCls", "min", "max", "step", "defaultValue", "value", "disabled", "readonly", "keyboard", "controls", "autofocus", "stringMode", "parser", "formatter", "precision", "decimalSeparator", "onChange", "onInput", "onPressEnter", "onStep", "lazy", "class", "style"]), {
        upHandler: Qe,
        downHandler: Ze
      } = a, _e = `${o}-input`, be = {};
      return Ke ? be.onChange = H : be.onInput = H, h("div", {
        class: j(o, Xe, {
          [`${o}-focused`]: p.value,
          [`${o}-disabled`]: ae,
          [`${o}-readonly`]: le,
...
const Dt = (e) => {
  ...
  return {
    [`${t}-affix-wrapper`]: v(v(v({}, We(e)), He(e, `${t}-affix-wrapper`)), {
...
const je = ke(), At = () => v(v({}, je), {
  ...
  setup(e, t) {
    ...
    const d = ft(), p = pt.useInject(), f = W(() => mt(p.status, e.status)), {
      prefixCls: c,
      size: s,
      direction: $,
      disabled: w
    ...
    }), [D, y] = _t(c), N = W(() => I.value || s.value), A = P(e.value === void 0 ? e.defaultValue : e.value), V = P(!1);
    Y(() => e.value, () => {
      A.value = e.value;
    });
    const q = P(null), ee = () => {
    ...
    return () => {
      ...
      const {
        ...
        prefix: G = (H = i.prefix) === null || H === void 0 ? void 0 : H.call(i),
        valueModifiers: ae = {}
      ...
      let F = h(Pt, R(R({}, ht(le, ["size", "defaultValue"])), {}, {
        ref: q,
        lazy: !!ae.lazy,
        value: A.value,
        class: ce,
      ...
      if (pe || T) {
        const U = j(`${g}-affix-wrapper`, he(`${g}-affix-wrapper`, f.value, T), {
      ...
      if (fe) {
        const U = `${g}-group`, me = `${U}-addon`, ge = x ? h("div", {
          class: me
        }, [x]) : null, ve = M ? h("div", {
          class: me
        }, [M]) : null, De = j(`${g}-wrapper`, U, {
          [`${U}-rtl`]: $.value === "rtl"
