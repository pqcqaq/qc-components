import { i as oo, m as eo, _ as I, r as j, ab as V, S as to, u as K, F as ro, d as A, c as H, g as L, h as D, b as z, P as U, f as E, s as _, a as no } from "./index-DELjRDde.js";
import { provide as N, inject as X, defineComponent as W, computed as O, ref as F, createVNode as T, watch as io, nextTick as ao } from "vue";
import { V as lo } from "./Checkbox-DExO1x-H.js";
import { o as so } from "./omit-CP-pNPup.js";
...
const Y = () => ({
  ...
  setup(o, r) {
    ...
    const s = K(), w = ro.useInject(), C = bo(), b = uo(), B = A(), g = O(() => {
      var l;
      ...
      direction: c,
      disabled: h
    } = H("radio", o), i = O(() => (b == null ? void 0 : b.optionType.value) === "button" || C === "button" ? `${x.value}-button` : x.value), m = A(), [u, p] = Q(x);
    t({
      focus: () => {
        f.value.focus();
      },
    ...
    return () => {
      ...
      const S = b, {
        ...
        prefixCls: i.value,
        id: G
      }, so(M, ["onUpdate:checked", "onUpdate:value"])), {
  ...
  setup(o, r) {
    ...
    return io(() => o.value, (c) => {
      ...
      onChange: (c) => {
        ...
        "value" in o || (g.value = i), !f.value && i !== h && (f.value = !0, t("update:value", i), t("change", c), d.onFieldChange()), ao(() => {
          f.value = !1;
        });
      },
      value: g,
