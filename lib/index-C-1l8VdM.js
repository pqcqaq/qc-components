import { aM as We, S as $e, P as w, _ as c, h as y, Y as he, k as J, g as U, aN as Ve, aO as je, aP as _e, i as Ge, m as Xe, av as Ke, G as Ue, r as Qe, a3 as Ye, a5 as ae, c as ke, w as Se, az as k, C as qe, aQ as Ze, p as Je, E as _, a1 as te, aR as we, l as eo, aS as oo, U as no, V as to, aT as lo, aU as ao, aV as io, aW as ro, aX as so, aY as co, a6 as uo } from "./index-DELjRDde.js";
import { defineComponent as O, ref as K, computed as q, createVNode as s, Transition as Te, withDirectives as Be, vShow as Pe, nextTick as fo, shallowRef as S, watch as Z, onBeforeUnmount as ie, watchEffect as mo, Fragment as go, onMounted as po, render as de, unref as vo, isRef as Co } from "vue";
import { K as ue } from "./KeyCode-n3eOOGSl.js";
import { o as Fe } from "./omit-CP-pNPup.js";
import { p as yo } from "./pickAttrs-DTpYtexn.js";
...
Ze() && Je(document.documentElement, "click", Ao, !0);
const Ro = () => ({
  prefixCls: String,
  ...
  setup(e, o) {
    ...
    return () => {
      ...
      return u(s(Po, y(y(y({}, z), l), {}, {
        ...
        transitionName: k(v.value, "zoom", e.transitionName),
        maskTransitionName: k(v.value, "fade", e.maskTransitionName),
...
const Ie = O({
  ...
  setup(e, o) {
    ...
    return process.env.NODE_ENV !== "production" && Se(e.visible === void 0, "Modal", "`visible` is deprecated, please use `open` instead."), () => {
      ...
      const ee = e.okType || "primary", oe = e.prefixCls || "ant-modal", X = `${oe}-confirm`, Re = t.style || {}, se = $ ?? F === "confirm", ce = e.autoFocusButton === null ? !1 : e.autoFocusButton || "ok", Y = `${oe}-confirm`, Ee = U(Y, `${Y}-${e.type}`, {
        [`${Y}-rtl`]: A === "rtl"
      ...
      return s(P, {
        ...
        title: "",
        footer: "",
        transitionName: k(H, "zoom", e.transitionName),
        maskTransitionName: k(H, "fade", e.maskTransitionName),
        mask: T,
        maskClosable: B,
        maskStyle: x,
        style: Re,
