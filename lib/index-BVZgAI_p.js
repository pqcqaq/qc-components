import { aN as We, U as $e, P as w, _ as c, h as y, Z as he, k as J, g as U, aO as Ve, aP as je, aQ as _e, i as Ge, m as Xe, aw as Ke, r as Ue, H as Qe, a3 as ke, a6 as ae, c as Ye, w as Se, aA as Y, C as Ze, aR as qe, p as Je, G as _, a2 as te, aS as we, l as eo, aT as oo, V as no, X as to, aU as lo, aV as ao, aW as io, aX as ro, aY as so, aZ as co, a7 as uo } from "./index-DGUz0BTe.js";
import { defineComponent as O, ref as K, computed as Z, createVNode as s, Transition as Te, withDirectives as Be, vShow as Pe, nextTick as fo, shallowRef as S, watch as q, onBeforeUnmount as ie, watchEffect as mo, Fragment as go, onMounted as po, render as de, unref as vo, isRef as Co } from "vue";
import { K as ue } from "./KeyCode-n3eOOGSl.js";
import { o as Fe } from "./omit-COyW2GJT.js";
import { p as yo } from "./pickAttrs-BR2EV0Wa.js";
...
const pe = {
  ...
  setup(e, o) {
    ...
    const l = S(), d = S(), g = S(), v = S(e.visible), b = S(`vcDialogTitle${ho()}`), f = (m) => {
      ...
      if (e.keyboard && m.keyCode === ue.ESC) {
        m.stopPropagation(), u(m);
        return;
      }
      e.visible && m.keyCode === ue.TAB && g.value.changeActive(!m.shiftKey);
    };
    return q(() => e.visible, () => {
      e.visible && (v.value = !0);
    }, {
      ...
      return s("div", y({
        ...
        onClick: x,
        role: "dialog",
        "aria-labelledby": V ? b.value : null,
        style: c(c({
          zIndex: F
        }, z), {
          display: v.value ? null : "none"
        })
      }, W), [s(wo, y(y({}, Fe(e, ["scrollLocker"])), {}, {
        style: R,
        class: M,
        onMousedown: r,
        onMouseup: p,
...
const Fo = (e) => {
  ...
  return [Io(l), Mo(l), Oo(l), Fo(l), e.wireframe && No(l), Ke(l, "zoom")];
});
var Ho = function(e, o) {
  var t = {};
  for (var n in e)
...
qe() && Je(document.documentElement, "click", Ao, !0);
const Ro = () => ({
  prefixCls: String,
  ...
  setup(e, o) {
    ...
    Se(e.visible === void 0, "Modal", "`visible` will be removed in next major version, please use `open` instead.");
    const a = (x) => {
    ...
    return () => {
      ...
      return u(s(Po, y(y(y({}, z), l), {}, {
        ...
        transitionName: Y(v.value, "zoom", e.transitionName),
        maskTransitionName: Y(v.value, "fade", e.maskTransitionName),
  ...
  setup(e, o) {
    ...
    po(() => {
      e.autofocus && (g = setTimeout(() => {
        var i, a;
        return (a = (i = eo(l.value)) === null || i === void 0 ? void 0 : i.focus) === null || a === void 0 ? void 0 : a.call(i);
      }));
    }), ie(() => {
      clearTimeout(g);
    });
...
const Ie = O({
  ...
  setup(e, o) {
    ...
    const [n] = ae("Modal");
    return process.env.NODE_ENV !== "production" && Se(e.visible === void 0, "Modal", "`visible` is deprecated, please use `open` instead."), () => {
      const {
        icon: l,
        onCancel: d,
        onOk: g,
      ...
      const ee = e.okType || "primary", oe = e.prefixCls || "ant-modal", X = `${oe}-confirm`, Re = t.style || {}, se = $ ?? F === "confirm", ce = e.autoFocusButton === null ? !1 : e.autoFocusButton || "ok", k = `${oe}-confirm`, De = U(k, `${k}-${e.type}`, {
        [`${k}-rtl`]: A === "rtl"
      }, t.class), ne = n.value, Ee = se && s(be, {
        actionFn: d,
        close: v,
        autofocus: ce === "cancel",
        buttonProps: m,
        ...
        default: () => [j(e.cancelText) || ne.cancelText]
      });
      return s(P, {
        prefixCls: oe,
        class: De,
        ...
        title: "",
        footer: "",
        transitionName: Y(H, "zoom", e.transitionName),
        maskTransitionName: Y(H, "fade", e.maskTransitionName),
        mask: T,
        maskClosable: B,
        maskStyle: x,
        style: Re,
        ...
        default: () => [s("div", {
          class: `${X}-body-wrapper`
        }, [s("div", {
          class: `${X}-body`
        }, [j(M), N === void 0 ? null : s("span", {
          class: `${X}-title`
        }, [j(N)]), s("div", {
          class: `${X}-content`
        }, [j(z)])]), R !== void 0 ? j(R) : s("div", {
          class: `${X}-btns`
        }, [Ee, s(be, {
          type: ee,
          actionFn: g,
          ...
          default: () => [j(b) || (se ? ne.okText : ne.justOkText)]
        })])])]
      });
    };
  }
  ...
  let t = c(c({}, Fe(e, ["parentContext", "appContext"])), {
    close: d,
    open: !0
  }), n = null;
  function l() {
  ...
  function g(f) {
    typeof f == "function" ? t = f(t) : t = c(c({}, t), f), n && ao(n, t, o);
  }
  const v = (f) => {
    const u = ro, i = u.prefixCls, a = f.prefixCls || `${i}-modal`, r = u.iconPrefixCls, p = so();
    return s(io, y(y({}, u), {}, {
      prefixCls: i
    }), {
      default: () => [s(Ie, y(y({}, f), {}, {
  ...
  function b(f) {
    const u = s(v, c({}, f));
    return u.appContext = e.parentContext || e.appContext || u.appContext, de(u, o), u;
  }
  return n = b(t), D.push(d), {
    destroy: d,
    update: g
  };
};
...
const Lo = () => ({
  ...
  setup(e, o) {
    ...
    const a = (n = d.value.okCancel) !== null && n !== void 0 ? n : d.value.type === "confirm", [r] = ae("Modal", uo.Modal);
    return () => s(Ie, y(y({
      prefixCls: b,
      rootPrefixCls: f
    }, d.value), {}, {
...
function jo() {
  ...
  const t = (d) => function(v) {
    var b;
    xe += 1;
    const f = S(!0), u = S(null), i = S(vo(v)), a = S({});
    q(() => v, (C) => {
      h(c(c({}, Co(C) ? C.value : C), a.value));
    });
    const r = function() {
      f.value = !1;
    ...
    p = (b = e.value) === null || b === void 0 ? void 0 : b.addModal(x), p && D.push(p);
    const h = (C) => {
