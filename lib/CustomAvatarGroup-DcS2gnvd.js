import { shallowRef as k, onMounted as X, onUnmounted as se, inject as ce, provide as ue, defineComponent as _, computed as G, watch as I, nextTick as N, createVNode as f, ref as pe, Fragment as V, watchEffect as de, openBlock as E, createElementBlock as W, unref as j, normalizeProps as ge, guardReactiveProps as ve, withCtx as L, renderList as me, createBlock as fe, mergeProps as he, createTextVNode as Se, toDisplayString as xe } from "vue";
import { at as ye, i as q, m as J, _ as m, r as K, c as M, au as $e, J as Q, h as C, P as be, av as Ce, aw as Pe, ax as ze, j as ke, k as we, ay as Be, w as Ae, g as Te, T as _e, az as Re, aA as Oe, Q as D, a0 as F, e as Ne, ag as Ee } from "./index-DELjRDde.js";
import { R as Ge } from "./index-BUV0Oo8p.js";
import { e as Me } from "./eagerComputed-B06AqR4q.js";
import { o as He } from "./omit-CP-pNPup.js";
function Ie() {
  const e = k({});
  let t = null;
  const r = ye();
...
const We = (e) => {
...
}), Z = Symbol("AvatarContextKey"), Le = () => ce(Z, {}), De = (e) => ue(Z, e), Fe = () => ({
  prefixCls: String,
  shape: {
    type: String,
    default: "circle"
  ...
  setup(e, t) {
    ...
    const n = k(!0), d = k(!1), l = k(1), u = k(null), g = k(null), {
      prefixCls: p
    } = M("avatar", e), [c, y] = U(p), i = Le(), a = G(() => e.size === "default" ? i.size : e.size), S = Ie(), v = Me(() => {
    ...
    return I(() => e.src, () => {
      ...
      const {
        ...
        draggable: te,
        crossOrigin: oe
      } = e, re = (s = i.shape) !== null && s !== void 0 ? s : z, B = Q(r, e, "icon"), P = p.value, ne = {
        [`${o.class}`]: !!o.class,
        [P]: !0,
        [`${P}-lg`]: a.value === "large",
        [`${P}-sm`]: a.value === "small",
      ...
      } : {}, H = (x = r.default) === null || x === void 0 ? void 0 : x.call(r);
      let A;
      if (R && n.value)
        A = f("img", {
          draggable: te,
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: l,
      configProvider: u
    } = M("popover", e), [g, p] = Je(l), c = G(() => u.getPrefixCls()), y = () => {
      var i, a;
      const {
    ...
    return () => {
      ...
      return g(f(_e, C(C(C({}, He(e, ["title", "content"])), n), {}, {
        prefixCls: l.value,
        ref: d,
        overlayClassName: i,
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: n,
      direction: d
    } = M("avatar", e), l = G(() => `${n.value}-group`), [u, g] = U(n);
    return de(() => {
      const p = {
        size: e.size,
        shape: e.shape
...
const nt = /* @__PURE__ */ _({
  ...
  setup(e) {
    const t = e;
    return (r, o) => (E(), W("div", null, [
      f(j(T), ge(ve(t.groupProps)), {
        default: L(() => [
          (E(!0), W(V, null, me(t.avatarGroupValue, (n) => (E(), fe(j(w), he({
            key: n.key,
            ref_for: !0
          }, t.avatarProps, {
            src: n.src
