import { defineComponent as F, ref as B, createVNode as A, onMounted as W, computed as _, openBlock as M, createBlock as k, mergeProps as G } from "vue";
import { c as y, k as N, u as P, l as D, N as j, S as E, h as I, b1 as V, aj as x } from "./index-DyhArEBu.js";
const v = () => null;
v.isSelectOption = !0;
...
const z = () => y(y({}, j(V(), ["loading", "mode", "optionLabelProp", "labelInValue"])), {
  dataSource: Array,
  dropdownMenuStyle: {
    type: Object,
    default: void 0
  ...
  setup(t, c) {
    ...
    const d = B(), a = () => {
      var l;
      const i = x((l = e.default) === null || l === void 0 ? void 0 : l.call(e));
    ...
    return () => {
      ...
      const $ = j(y(y(y({}, t), O), {
        mode: E.SECRET_COMBOBOX_MODE_DO_NOT_USE,
        // optionLabelProp,
        getInputElement: a,
        notFoundContent: r,
        // placeholder: '',
      ...
      return A(E, $, I({
        default: () => [p]
      }, j(e, ["default", "dataSource", "options"])));
    };
  }
}), K = y(w, {
  Option: v,
