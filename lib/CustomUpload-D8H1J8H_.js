import { defineComponent as H, computed as R, createVNode as c, Fragment as ut, ref as Z, onUpdated as Ft, onMounted as ye, onBeforeUnmount as dt, shallowRef as ce, watch as pt, Transition as Rt, withDirectives as ft, vShow as gt, watchEffect as Tt, triggerRef as jt, TransitionGroup as Lt, toRef as At, openBlock as re, createBlock as ue, mergeProps as We, toHandlers as Xe, withCtx as Se, createElementVNode as oe, createElementBlock as Ve, unref as de, createTextVNode as Et, toDisplayString as Oe, createCommentVNode as Ge, pushScopeId as Ut, popScopeId as Mt } from "vue";
import { M as kt, N as Nt, O as zt, Q as Bt, s as B, f as _, b as z, R as je, D as G, C as K, A as Q, S as Fe, _ as D, h as F, k as ie, T as mt, i as vt, m as ht, r as yt, U as Le, c as be, V as Ht, X as Wt, Y as Xt, j as Vt, I as te, Z as Gt, $ as qt, a as ve, a0 as Yt, a1 as Jt, a2 as Qt, a3 as Zt, L as Re, n as Kt, a4 as Te, a5 as bt, a6 as wt, z as en, a7 as tn, u as nn, d as rn, a8 as on, a9 as ln, g as ae, e as an, aa as Pe, ab as sn } from "./index-DQQY7Ife.js";
import { P as cn } from "./PlusOutlined-DW0Qwn17.js";
import { E as un } from "./EyeOutlined-DpGtsuUS.js";
import { C as dn } from "./CheckOutlined-BpfaKUOu.js";
import { u as pn } from "./useRefs-CuWy3iND.js";
import { u as fn } from "./useMergedState-6HyZ0xMy.js";
function gn(e, t, n, r) {
...
function he(e) {
  ...
  return t && "progress" in t && (Q(!1, "Progress", "`success.progress` is deprecated. Please use `success.percent` instead."), r = t.progress), t && "percent" in t && (r = t.percent), r;
}
function On(e) {
  let {
    percent: t,
...
const $e = (e, t, n) => {
  ...
  if (t === "step") {
    ...
    (t === "circle" || t === "dashboard") && (typeof e == "string" || typeof e > "u" ? [s, u] = e === "small" ? [60, 60] : [120, 120] : typeof e == "number" ? [s, u] = [e, e] : (process.env.NODE_ENV !== "production" && Q(!1, "Progress", 'Type "circle" and "dashboard" do not accept array as `size`, please use number or preset size instead.'), s = (o = (r = e[0]) !== null && r !== void 0 ? r : e[1]) !== null && o !== void 0 ? o : 120, u = (i = (a = e[0]) !== null && a !== void 0 ? a : e[1]) !== null && i !== void 0 ? i : 120));
  return {
    width: s,
    height: u
  };
...
const In = () => D(D({}, we()), {
  ...
  setup(e, t) {
    ...
    process.env.NODE_ENV !== "production" && Q("strokeWidth" in e, "Progress", "`strokeWidth` is deprecated. Please use `size` instead.");
    const b = R(() => {
      const {
        percent: d
      } = e;
...
const An = H({
  ...
  setup(e) {
    qe += 1;
    const t = Z(qe), n = R(() => Je(e.percent)), r = R(() => Je(e.strokeColor)), [o, a] = pn();
    Tn(a);
    const i = () => {
      const {
        prefixCls: s,
    ...
    return () => {
      ...
      return c("svg", F({
        ...
        x2: "0%",
        y2: "0%"
      }, [Object.keys(f).sort((v, P) => Ye(v) - Ye(P)).map((v, P) => c("stop", {
        key: P,
        offset: v,
        "stop-color": f[v]
...
const Yn = H({
  ...
  setup(e, t) {
    ...
    process.env.NODE_ENV !== "production" && (Q("successPercent" in e, "Progress", "`successPercent` is deprecated. Please use `success.percent` instead."), Q("width" in e, "Progress", "`width` is deprecated. Please use `size` instead."));
    const u = R(() => Array.isArray(e.strokeColor) ? e.strokeColor[0] : e.strokeColor), b = R(() => {
      ...
      if (!w)
        return null;
      let v;
      const P = l || (n == null ? void 0 : n.format) || ((A) => `${A}%`), L = g === "line";
      return l || n != null && n.format || p.value !== "exception" && p.value !== "success" ? v = P(ee(x), ee(y)) : p.value === "exception" ? v = L ? c(Ht, null, null) : c(Wt, null, null) : p.value === "success" && (v = L ? c(Xt, null, null) : c(dn, null, null)), c("span", {
        class: `${o.value}-text`,
...
var Qn = { icon: { tag: "svg", attrs: { viewBox: "64 64 896 896", focusable: "false" }, children: [{ tag: "path", attrs: { d: "M360 184h-8c4.4 0 8-3.6 8-8v8h304v-8c0 4.4 3.6 8 8 8h-8v72h72v-80c0-35.3-28.7-64-64-64H352c-35.3 0-64 28.7-64 64v80h72v-72zm504 72H160c-17.7 0-32 14.3-32 32v32c0 4.4 3.6 8 8 8h60.4l24.7 523c1.6 34.1 29.8 61 63.9 61h454c34.2 0 62.3-26.8 63.9-61l24.7-523H888c4.4 0 8-3.6 8-8v-32c0-17.7-14.3-32-32-32zM731.3 840H292.7l-24.2-512h487l-24.2 512z" } }] }, name: "delete", theme: "outlined" };
function Ze(e) {
...
const Ie = (e, t) => {
  if (e && t) {
    ...
    return n.some((i) => {
      ...
      return /\/\*$/.test(s) ? a === s.replace(/\/.*$/, "") : o === s ? !0 : /^\w+$/.test(s) ? (Gt(!1, `Upload takes an invalidate 'accept' type '${s}'.Skip for check.`), !0) : !1;
    });
  }
  return !0;
};
...
const ar = H({
  ...
  setup(e, t) {
    ...
    const b = (f, y) => ir(this, void 0, void 0, function* () {
      ...
      let A;
      typeof L == "function" ? A = yield L(f) : A = L;
      const {
        data: k
      } = e;
      let U;
      ...
      const {
        ...
        onSuccess: (T, E) => {
          ...
          j == null || j(T, L, E), delete i[C];
        },
        onError: (T, E) => {
          const {
            onError: j
          } = e;
          j == null || j(T, E, L), delete i[C];
        }
      };
      A(v), i[C] = S(I);
    }, O = () => {
    ...
    const d = (f) => {
      ...
      Promise.all(v).then((P) => {
        ...
        })), P.filter((A) => A.parsedFile !== null).forEach((A) => {
          p(A);
        });
      });
    }, w = (f) => {
      const {
        ...
        files: P
      } = f.target, L = [...P].filter((A) => !v || Ie(A, y));
      d(L), O();
    }, l = (f) => {
      const y = s.value;
      if (!y)
      ...
      if (f.preventDefault(), f.type !== "dragover")
        if (e.directory)
          ...
          const v = Cn(Array.prototype.slice.call(f.dataTransfer.files), (A) => Ie(A, e.accept));
          let P = v[0];
          const L = v[1];
...
Ee.displayName = "PaperClipOutlined";
Ee.inheritAttrs = !1;
...
function Ct() {
  return {
    ...
    remove: _(),
    supportServerRender: z(),
    disabled: z(),
    prefixCls: String,
    customRequest: _(),
    withCredentials: z(),
    openFileDialogOnClick: z(),
    locale: G(),
    id: String,
    previewFile: _(),
...
function yr(e) {
  return new Promise((t) => {
    ...
    n.width = J, n.height = J, n.style.cssText = `position: fixed; left: 0; top: 0; width: ${J}px; height: ${J}px; z-index: 9999; display: none;`, document.body.appendChild(n);
    ...
    if (o.onload = () => {
      ...
      let s = J, u = J, b = 0, p = 0;
      a > i ? (u = i * (J / a), p = -(u - s) / 2) : (s = a * (J / i), b = -(s - u) / 2), r.drawImage(o, b, p, s, u);
      const O = n.toDataURL();
...
const $r = () => ({
  ...
  setup(e, t) {
    ...
    return () => {
      ...
      const M = {
      ...
      }, q = typeof l.linkProps == "string" ? JSON.parse(l.linkProps) : l.linkProps, ne = A ? y({
        customIcon: N ? N({
          file: l
        }) : c(Ae, null, null),
        callback: () => S(l),
      ...
      }, [X, ne]), Y = `${h}-list-item-name`, le = l.url ? [c("a", F(F({
        key: "view",
        target: "_blank",
        rel: "noopener noreferrer",
        class: Y,
        ...
        file: l
      }) : c(un, null, null)]) : null, Pt = w === "picture-card" && s.value !== "uploading" && c("span", {
        class: `${h}-list-item-actions`
      }, [Ot, s.value === "done" && X, ne]), Be = c("div", {
        class: M
      }, [j, le, Pt, a.value && c(Rt, b.value, {
        default: () => [ft(c("div", {
          class: `${h}-list-item-progress`
        }, ["percent" in l ? c(Jn, F(F({}, x), {}, {
          type: "line",
          percent: l.percent
  ...
  var r;
  return Zt((r = n.default) === null || r === void 0 ? void 0 : r.call(n))[0];
}, Or = H({
  compatConfig: {
    MODE: 3
  },
  ...
  setup(e, t) {
    ...
    const i = (l, g) => {
      ...
      let v = f ? c(Re, null, null) : c(Ee, null, null);
    ...
    const {
      ...
      const l = D({}, Jt(`${h.value}-motion-collapse`));
      delete l.onAfterAppear, delete l.onAfterEnter, delete l.onAfterLeave;
      const g = D(D({}, Qt(`${O.value}-${e.listType === "picture-card" ? "animate-inline" : "animate"}`)), {
        class: d.value,
        appear: o.value
      });
  ...
  return {
    [`${t}-wrapper${t}-picture-card-wrapper`]: D(D({}, wt()), {
      display: "inline-block",
      width: "100%",
      [`${t}${t}-select`]: {
        width: s,
      ...
      [`${a}${a}-picture-card`]: {
        ...
        [`${i}-actions, ${i}-actions:hover`]: {
          [`${n}-eye, ${n}-download, ${n}-delete`]: {
            color: new en(o).setAlpha(0.65).toRgbString(),
            "&:hover": {
              color: o
            }
          }
  ...
  return [Rr(s), Pr(s), _r(s), Dr(s), xr(s), Ir(s), Fr(s), tn(s)];
});
...
const se = `__LIST_IGNORE_${Date.now()}__`, ge = H({
  ...
  setup(e, t) {
    ...
    const a = nn(), {
      ...
      direction: s,
      disabled: u
    } = be("upload", e), [b, p] = Tr(i), O = rn(), h = R(() => {
      var m;
      return (m = u.value) !== null && m !== void 0 ? m : O.value;
    }), [d, w] = fn(e.defaultFileList || [], {
      value: At(e, "fileList"),
      postState: (m) => {
        const $ = Date.now();
    ...
    ye(() => {
      Q(e.fileList !== void 0 || r.value === void 0, "Upload", "`value` is not a valid prop, do you mean `fileList`?"), Q(e.transformFile === void 0, "Upload", "`transformFile` is deprecated. Please use `beforeUpload` directly."), Q(e.remove === void 0, "Upload", "`remove` props is deprecated. Please use `remove` event.");
    });
    const x = (m, $, C) => {
      var S, I;
      let T = [...$];
      ...
      C && (E.event = C), (S = e["onUpdate:fileList"]) === null || S === void 0 || S.call(e, E.fileList), (I = e.onChange) === null || I === void 0 || I.call(e, E), a.onFieldChange();
    ...
    const [U] = on("Upload", ln.Upload, R(() => e.locale)), N = (m, $) => {
      const {
        removeIcon: C,
        previewIcon: S,
        downloadIcon: I,
    ...
    return () => {
      ...
      const ne = ae(i.value, {
        ...
        [`${i.value}-disabled`]: h.value,
        [`${i.value}-rtl`]: s.value === "rtl"
      }), X = an((C = n.default) === null || C === void 0 ? void 0 : C.call(n)), V = (Y) => c("div", {
        class: ne,
        style: Y
      }, [c(et, F(F({}, M), {}, {
        ref: g
...
ze.displayName = "UploadOutlined";
ze.inheritAttrs = !1;
const zr = (e) => (Ut("data-v-13425e11"), e = e(), Mt(), e), Br = { class: "inner" }, Hr = {
  key: 0,
  class: "btn"
}, Wr = {
  key: 1,
  class: "image"
}, Xr = { class: "ant-upload-text" }, Vr = { class: "ant-upload-drag-icon" }, Gr = { class: "ant-upload-text" }, qr = /* @__PURE__ */ zr(() => /* @__PURE__ */ oe("p", { class: "ant-upload-hint" }, "点击这里/将文件拖拽到这里即可自动上传", -1)), Yr = /* @__PURE__ */ H({
  __name: "CustomUpload",
  props: {
    value: {},
    msg: {},
        ...
        default: Se(() => [
          oe("div", Br, [
            ...
            n.uploadType == "Image" ? (re(), Ve("div", Wr, [
              oe("div", null, [
                i.value ? (re(), ue(de(Re), { key: 0 })) : (re(), ue(de(cn), { key: 1 })),
...
}), ro = /* @__PURE__ */ sn(Yr, [["__scopeId", "data-v-13425e11"]]);
export {
  ro as default
};
