import { g as pe, h as U, n as he, e as ze, _ as E, aj as Y, af as _e, k as De, ak as Pe, P as se, u as Ge, F as Ke, A as We, c as Ue, ad as Xe, d as Ye, aA as qe, ae as Je, b2 as Qe, E as Ne, s as fe, b as Ze, f as et } from "./index-DGUz0BTe.js";
import { provide as tt, inject as nt, defineComponent as Oe, computed as S, reactive as lt, watch as ye, toRaw as Me, nextTick as Ae, createVNode as H, Fragment as ot, shallowRef as ie, watchEffect as me, toRef as Q, ref as Te } from "vue";
import { u as at, L as it, T as st, f as ut, i as Le, h as Se, b as rt, j as ct, k as dt, t as ft, B as vt, d as mt, e as pt, g as ht } from "./index-DJfLjw5f.js";
import { K as W } from "./KeyCode-n3eOOGSl.js";
import { p as bt } from "./pickAttrs-BR2EV0Wa.js";
import { u as gt } from "./move-C7FDUX8Z.js";
import { o as be } from "./omit-COyW2GJT.js";
import { u as Ee } from "./useMergedState-6HyZ0xMy.js";
import { g as yt, a as St } from "./statusUtils-FU9aJEap.js";
function Ot() {
...
const Tt = () => E(E({}, be($e(), ["inputIcon", "mode", "getInputElement", "getRawInputElement", "backfill"])), {
  ...
  setup(e, c) {
    ...
    } = Xe(w, C), P = S(() => _.value || X.value), B = Ye(), z = S(() => {
      var h;
      return (h = o.value) !== null && h !== void 0 ? h : B.value;
    }), [ue, G] = pt(w), R = S(() => D()), re = S(() => e.placement !== void 0 ? e.placement : C.value === "rtl" ? "bottomRight" : "bottomLeft"), L = S(() => qe(R.value, Je(re.value), e.transitionName)), Z = S(() => pe({
    ...
    return () => {
      ...
      let N;
      te !== void 0 ? N = te : n.notFoundContent ? N = n.notFoundContent() : I.value === "combobox" ? N = null : N = (k == null ? void 0 : k("Select")) || H(Qe, {
