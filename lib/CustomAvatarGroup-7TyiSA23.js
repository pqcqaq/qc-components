import { inject as ie, provide as se, defineComponent as _, shallowRef as T, computed as M, watch as H, nextTick as E, onMounted as ce, createVNode as f, ref as ue, Fragment as X, watchEffect as pe, openBlock as G, createElementBlock as I, unref as L, normalizeProps as de, guardReactiveProps as ge, withCtx as W, renderList as ve, createBlock as me, mergeProps as fe, createTextVNode as he, toDisplayString as Se } from "vue";
import { g as V, m as Z, c as m, r as q, u as O, bg as xe, bh as ye, bi as be, Q as K, bj as $e, h as C, P as Ce, bk as Pe, bl as ze, bm as ke, w as we, i as Be, bn as Te, k as Ae, f as _e, T as Re, bo as Ne, N as Ee, bp as Ge, Z as D, ab as F, aj as Me, aL as Oe } from "./index-DyhArEBu.js";
const je = (e) => {
  const {
    antCls: t,
    componentCls: r,
...
}), J = Symbol("AvatarContextKey"), Ie = () => ie(J, {}), Le = (e) => se(J, e), We = () => ({
  prefixCls: String,
  shape: {
    type: String,
    default: "circle"
  ...
  setup(e, t) {
    ...
    const n = T(!0), d = T(!1), l = T(1), u = T(null), g = T(null), {
      prefixCls: p
    } = O("avatar", e), [c, y] = Q(p), i = Ie(), a = M(() => e.size === "default" ? i.size : e.size), S = xe(), v = ye(() => {
    ...
    return H(() => e.src, () => {
      ...
      const {
        ...
        draggable: ee,
        crossOrigin: te
      } = e, oe = (s = i.shape) !== null && s !== void 0 ? s : z, w = K(r, e, "icon"), P = p.value, re = {
        [`${o.class}`]: !!o.class,
        [P]: !0,
        [`${P}-lg`]: a.value === "large",
        [`${P}-sm`]: a.value === "small",
      ...
      if (R && n.value)
        ...
        const N = `scale(${l.value}) translateX(-50%)`, ae = {
          msTransform: N,
          WebkitTransform: N,
          transform: N
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: l,
      configProvider: u
    } = O("popover", e), [g, p] = Ve(l), c = M(() => u.getPrefixCls()), y = () => {
      var i, a;
      const {
    ...
    return () => {
      ...
      return g(f(Re, C(C(C({}, Ee(e, ["title", "content"])), n), {}, {
        prefixCls: l.value,
        ref: d,
        overlayClassName: i,
        transitionName: Ne(c.value, "zoom-big", e.transitionName),
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: n,
      direction: d
    } = O("avatar", e), l = M(() => `${n.value}-group`), [u, g] = Q(n);
    return pe(() => {
      const p = {
        size: e.size,
        shape: e.shape
...
const Ye = /* @__PURE__ */ _({
  ...
  setup(e) {
    const t = e;
    return (r, o) => (G(), I("div", null, [
      f(L(A), de(ge(t.groupProps)), {
        default: W(() => [
          (G(!0), I(X, null, ve(t.avatarGroupValue, (n) => (G(), me(L(k), fe({
            key: n.key,
            ref_for: !0
          }, t.avatarProps, {
            src: n.src
