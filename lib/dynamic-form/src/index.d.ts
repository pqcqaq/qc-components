...
import { MentionsProps, TimePickerProps, TreeSelectProps, UploadChangeParam, UploadProps } from 'ant-design-vue';
import { CSSProperties, Component, Slot, VNode } from 'vue';
import { Dayjs } from 'dayjs';

export declare const componentsMap: Record<string, {
    component: Component;
...
export type DyFormItem = {
    ...
    value?: string | number | boolean | string[] | number[] | File | File[] | null;
