import { createVNode as S, defineComponent as V, computed as U, ref as q, reactive as J, watch as Y, onMounted as Z, openBlock as k, createBlock as ee, unref as te, normalizeProps as L, guardReactiveProps as M, createSlots as ne, renderList as le, withCtx as ae, renderSlot as oe } from "vue";
import { I as re, P as R, g as se, m as ie, _ as x, r as ce, D as ue, i as de, u as fe, x as ve, c as me, b as _, Q as he, M as pe } from "./styleChecker-DxpCOgAe.js";
import { K as D } from "./KeyCode-n3eOOGSl.js";
...
function ye(e) {
  const t = Se(e), a = e.ownerDocument, s = a.defaultView || a.parentWindow;
  return t.left += be(s), t.left;
}
...
const $e = {
  ...
  setup(e, t) {
    ...
    const s = (o) => {
      ...
      let m = o;
      return p === 0 && d === 0 && v ? m += ` ${o}-focused` : g && p + 0.5 >= b && p < b ? (m += ` ${o}-half ${o}-active`, v && (m += ` ${o}-focused`)) : (m += b <= p ? ` ${o}-full` : ` ${o}-zero`, b === p && v && (m += ` ${o}-focused`)), m;
    });
    return () => {
      const {
        disabled: o,
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: h,
      direction: o
    } = fe("rate", e), [d, p] = De(h), g = ve(), v = q(), [b, m] = ge(), n = J({
      value: e.value,
      focused: !1,
      cleanedValue: null,
      hoverValue: void 0
    ...
    const C = (l) => pe(m.value.get(l)), O = (l, c) => {
      ...
      let f = !1;
      r && (f = u === n.value), I(), w(f ? 0 : u), n.cleanedValue = f ? u : null;
    }, j = (l) => {
    ...
    return () => {
      const {
        ...
        class: F,
        style: H
      } = s, P = [], G = r ? `${h.value}-disabled` : "", W = e.character || a.character || (() => S(B, null, null));
      for (let $ = 0; $ < l; $++)
        P.push(S(xe, {
          ref: b($),
          key: $,
