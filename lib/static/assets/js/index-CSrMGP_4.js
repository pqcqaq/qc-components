import { g as E, m as L, _ as x, r as X, K as M, i as _, u as P, b as I, J as G, P as T, z as A } from "./styleChecker-DdDg1L8e.js";
import { defineComponent as B, shallowRef as H, watch as j, onBeforeUnmount as R, createVNode as r, isVNode as N, cloneVNode as O } from "vue";
function V(n, e, c) {
  var t = c || {}, i = t.noTrailing, m = i === void 0 ? !1 : i, b = t.noLeading, $ = b === void 0 ? !1 : b, y = t.debounceMode, a = y === void 0 ? void 0 : y, o, g = !1, f = 0;
  function D() {
    o && clearTimeout(o);
  }
  function w(d) {
    var v = d || {}, p = v.upcomingOnly, h = p === void 0 ? !1 : p;
    D(), g = !h;
  }
  function S() {
    for (var d = arguments.length, v = new Array(d), p = 0; p < d; p++)
      v[p] = arguments[p];
    var h = this, l = Date.now() - f;
    if (g)
      return;
    function u() {
    ...
    !$ && a && !o && u(), D(), a === void 0 && l > n ? $ ? (f = Date.now(), m || (o = setTimeout(a ? s : u, n))) : u() : m !== !0 && (o = setTimeout(a ? s : u, a === void 0 ? n - l : n));
  }
  return S.cancel = w, S;
}
function F(n, e, c) {
  var t = {}, i = t.atBegin, m = i === void 0 ? !1 : i;
  return V(n, e, {
    debounceMode: m !== !1
  });
}
const K = new M("antSpinMove", {
  to: {
    opacity: 1
  }
}), J = new M("antRotate", {
...
var Q = function(n, e) {
  var c = {};
  for (var t in n)
    Object.prototype.hasOwnProperty.call(n, t) && e.indexOf(t) < 0 && (c[t] = n[t]);
  if (n != null && typeof Object.getOwnPropertySymbols == "function")
    for (var i = 0, t = Object.getOwnPropertySymbols(n); i < t.length; i++)
      e.indexOf(t[i]) < 0 && Object.prototype.propertyIsEnumerable.call(n, t[i]) && (c[t[i]] = n[t[i]]);
  return c;
};
const W = () => ({
  prefixCls: String,
...
const z = B({
  ...
  setup(n, e) {
    ...
    const {
      ...
      size: m,
      direction: b
    } = P("spin", n), [$, y] = q(i), a = H(n.spinning && !Y(n.spinning, n.delay));
    let o;
    return j([() => n.spinning, () => n.delay], () => {
      o == null || o.cancel(), o = F(n.delay, () => {
        a.value = n.spinning;
      }), o == null || o();
    }, {
      immediate: !0,
      ...
      } = n, d = (f = t.default) === null || f === void 0 ? void 0 : f.call(t), v = {
        [y.value]: !0,
        [i.value]: !0,
      ...
      function p(l) {
        const u = `${l}-dot`;
        let s = A(t, n, "indicator");
        return s === null ? null : (Array.isArray(s) && (s = s.length === 1 ? s[0] : s), N(s) ? O(s, {
          class: u
        }) : C && N(C()) ? O(C(), {
          class: u
        }) : r("span", {
      ...
      if (d && G(d).length) {
        ...
        return $(r("div", {
          class: [`${i.value}-nested-loading`, n.wrapperClassName, y.value]
        }, [a.value && r("div", {
          key: "loading"
        }, [h]), r("div", {
          class: l,
