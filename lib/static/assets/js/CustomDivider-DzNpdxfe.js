import { defineComponent as m, computed as d, createVNode as u, openBlock as w, createBlock as z, unref as y, normalizeProps as C, guardReactiveProps as M, withCtx as B, createTextVNode as _, toDisplayString as I } from "vue";
import { g as T, m as D, _ as s, r as E, t as G, u as H, E as W, b as f } from "./styleChecker-DdDg1L8e.js";
const P = (t) => {
  const {
    componentCls: e,
  ...
  setup(t, e) {
    ...
    const {
      prefixCls: i,
      direction: p
    } = H("divider", t), [v, h] = A(i), c = d(() => t.orientation === "left" && t.orientationMargin != null), g = d(() => t.orientation === "right" && t.orientationMargin != null), x = d(() => {
      const {
        type: n,
        dashed: l,
        plain: b
    ...
    return () => {
      var n;
      const l = W((n = a.default) === null || n === void 0 ? void 0 : n.call(a));
  ...
  setup(t) {
    const e = t;
    return (a, r) => (w(), z(y(L), C(M(a.$attrs)), {
      default: B(() => [
        _(I(e.dividerText), 1)
      ]),
      _: 1
