import { I as nt, G as R, c as j, b as A, a2 as rt, U as Ae, _ as v, C as F, a3 as ee, D as ye, g as at, d as it, r as Ve, a4 as lt, x as ot, H as st, u as ut, V as dt, y as ct, X as Te, Y as Be, h as ft, P as be } from "./styleChecker-DdDg1L8e.js";
import { createVNode as h, defineComponent as Ie, ref as We, onBeforeUnmount as Ge, shallowRef as O, computed as H, watch as te } from "vue";
import { i as pt, D as mt } from "./DownOutlined-BHyFVLFp.js";
import { K as ie } from "./KeyCode-n3eOOGSl.js";
import { o as gt } from "./omit-CH0b8HlL.js";
import { a as vt, g as Se } from "./statusUtils-BkxkBBZV.js";
import { i as ht, g as Le, a as Ue, e as qe, c as bt, b as St, f as $t, d as Nt } from "./index-BefsX9p6.js";
...
function xe(e, t, n) {
  ...
  if (n >= 0) {
    const f = Number(d[n]);
    if (f >= 5 && !r) {
      const s = D(e).add(`${i}0.${"0".repeat(n)}${10 - f}`);
...
const ze = (e, t) => e || t.isEmpty() ? t.toString() : t.toNumber(), je = (e) => {
  ...
  setup(e, t) {
    ...
    const d = O(), c = O(!1), m = O(!1), f = O(!1), s = O(D(e.value));
    function w(a) {
    ...
    const P = H(() => je(e.max)), N = H(() => je(e.min)), x = H(() => !P.value || !s.value || s.value.isInvalidate() ? !1 : P.value.lessEquals(s.value)), V = H(() => !N.value || !s.value || s.value.isInvalidate() ? !1 : s.value.lessEquals(N.value)), [k, X] = Ct(d, c), K = (a) => P.value && !a.lessEquals(P.value) ? P.value : N.value && !N.value.lessEquals(a) ? N.value : null, le = (a) => !K(a), Y = (a, l) => {
      var u;
      let g = a, y = le(g) || g.isEmpty();
      if (!g.isEmpty() && !l && (g = K(g) || g, y = !0), !e.readonly && !e.disabled && y) {
        const M = g.toString(), B = S(M, l);
        return B >= 0 && (g = D(xe(M, ".", B))), g.equals(s.value) || (w(g), (u = e.onChange) === null || u === void 0 || u.call(e, g.isEmpty() ? null : ze(e.stringMode, g)), e.value === void 0 && C(g, l)), g;
      }
      return s.value;
    }, oe = Pt(), J = (a) => {
      var l;
      ...
      let g = D(e.step);
      a || (g = g.negate());
      const y = (s.value || D(0)).add(g.toString()), M = Y(y, !1);
    ...
    return te(() => e.precision, () => {
      ...
      return Ke ? he.onChange = W : he.onInput = W, h("div", {
        class: j(l, Ye, {
          [`${l}-focused`]: c.value,
          [`${l}-disabled`]: Z,
          [`${l}-readonly`]: ae,
...
const He = Xe(), Vt = () => v(v({}, He), {
  ...
  setup(e, t) {
    ...
    var d;
    const c = ot(), m = st.useInject(), f = H(() => vt(m.status, e.status)), {
      prefixCls: s,
      size: w,
      direction: S,
      disabled: I
      ...
      var b;
      return (b = I.value) !== null && b !== void 0 ? b : _.value;
    }), [P, N] = Rt(s), x = H(() => $.value || w.value), V = O((d = e.value) !== null && d !== void 0 ? d : e.defaultValue), k = O(!1);
    te(() => e.value, () => {
      V.value = e.value;
    });
    const X = O(null), K = () => {
    ...
    return () => {
      ...
      const {
        ...
        addonAfter: B = (W = o.addonAfter) === null || W === void 0 ? void 0 : W.call(o),
        prefix: Z = (G = o.prefix) === null || G === void 0 ? void 0 : G.call(o),
        valueModifiers: ae = {}
      } = a, Oe = At(a, ["class", "bordered", "readonly", "style", "addonBefore", "addonAfter", "prefix", "valueModifiers"]), p = s.value, ce = j({
        [`${p}-lg`]: x.value === "large",
        [`${p}-sm`]: x.value === "small",
        [`${p}-rtl`]: S.value === "rtl",
        [`${p}-readonly`]: g,
      ...
      let L = h(Ot, A(A({}, gt(Oe, ["size", "defaultValue"])), {}, {
        ref: X,
        lazy: !!ae.lazy,
        value: V.value,
        class: ce,
