...
import { au as ye, i as K, m as q, _ as m, r as U, c as M, av as $e, K as Z, h as C, P as be, aw as Ce, ax as Pe, ay as ze, j as ke, k as we, az as Be, w as Ae, g as Te, T as _e, aA as Re, aB as Oe, R as D, a1 as F, e as Ne, ah as Ee } from "./index-DGUz0BTe.js";
import { R as Ge } from "./index-BPMFHqJ9.js";
import { e as Me } from "./eagerComputed-B06AqR4q.js";
import { o as He } from "./omit-COyW2GJT.js";
function Ie() {
  const e = k({});
  let t = null;
  const r = ye();
...
const We = (e) => {
  ...
  setup(e, t) {
    ...
    const n = k(!0), d = k(!1), l = k(1), u = k(null), g = k(null), {
      prefixCls: p
    } = M("avatar", e), [c, y] = J(p), i = Le(), a = G(() => e.size === "default" ? i.size : e.size), S = Ie(), v = Me(() => {
    ...
    return I(() => e.src, () => {
      ...
      const {
        ...
        draggable: te,
        crossOrigin: oe
      } = e, re = (s = i.shape) !== null && s !== void 0 ? s : z, B = Z(r, e, "icon"), P = p.value, ne = {
        [`${o.class}`]: !!o.class,
        [P]: !0,
        [`${P}-lg`]: a.value === "large",
        [`${P}-sm`]: a.value === "small",
  ...
  return [Xe(n), Ve(n), o && Ke(n), Ce(n, "zoom-big")];
}, (e) => {
  let {
    zIndexPopupBase: t
  } = e;
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: l,
      configProvider: u
    } = M("popover", e), [g, p] = qe(l), c = G(() => u.getPrefixCls()), y = () => {
      var i, a;
      const {
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: n,
      direction: d
    } = M("avatar", e), l = G(() => `${n.value}-group`), [u, g] = J(n);
    return de(() => {
      const p = {
        size: e.size,
        shape: e.shape
