import { defineComponent as V, defineAsyncComponent as j, ref as m, onMounted as N, watch as A, withDirectives as T, openBlock as a, createElementBlock as r, normalizeStyle as g, withModifiers as X, createVNode as d, unref as C, withCtx as O, createCommentVNode as S, Fragment as Y, renderList as z, mergeProps as U, createTextVNode as $, toDisplayString as G } from "vue";
import { D as H, _ as W } from "./useFullScreenDyForm-Bf0u-fRX.js";
import { Modal as q } from "ant-design-vue";
import { C as J } from "./CloseOutlined-CVLQwoL6.js";
const K = {
  key: 0,
  class: "btns"
}, Q = /* @__PURE__ */ V({
  ...
  setup(E) {
    const h = j(() => import("./styleChecker-DdDg1L8e.js").then((t) => t.bU)), x = m(), F = (t) => {
      x.value = t;
    }, e = E, c = m({}), f = m(!1), y = m(e.schema);
    N(() => {
    ...
    return (t, o) => T((a(), r("div", {
      ...
      T((a(), r("div", {
        ...
        e.customBtns && e.customBtns.length > 0 ? (a(), r("div", {
          ...
          (a(!0), r(Y, null, z(e.customBtns, (n) => (a(), r("div", {
            key: n.text,
            style: g({
              display: "inline",
              justifyContent: "center",
...
}), ne = /* @__PURE__ */ W(Q, [["__scopeId", "data-v-bee87478"]]);
export {
  ne as default
};
