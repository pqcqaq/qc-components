import { e as tt, L as _, bC as nt, h as j, j as R, a6 as rt, y as Re, d as v, G as B, F as J, J as ye, K as ie, g as at, aR as lt, aS as it, r as Ae, aV as We, bc as He, aU as Ge, aT as ot, bd as st, bS as ut, be as dt, bT as ct, f as ft, aC as pt, aD as mt, u as gt, aE as vt, O as bt, aI as he, Q as ht, bU as St, bV as Ve, bW as Te, aM as $t, P as Se } from "./index-CNOMdpiO.js";
import { createVNode as h, defineComponent as Ie, ref as Le, onBeforeUnmount as Ue, shallowRef as P, computed as W, watch as Q } from "vue";
...
class U {
  ...
  toString() {
    return (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0) ? this.isInvalidate() ? "" : Y(`${this.getMark()}${this.getIntegerStr()}.${this.getDecimalStr()}`).fullStr : this.origin;
  }
}
function O(e) {
  ...
  setup(e, t) {
    ...
    return Q(() => e.precision, () => {
      ...
      const r = v(v({}, n), e), {
        ...
        class: Xe,
        style: Je
      } = r, Qe = Ot(r, ["prefixCls", "min", "max", "step", "defaultValue", "value", "disabled", "readonly", "keyboard", "controls", "autofocus", "stringMode", "parser", "formatter", "precision", "decimalSeparator", "onChange", "onInput", "onPressEnter", "onStep", "lazy", "class", "style"]), {
        upHandler: Ye,
        downHandler: Ze
      } = a, _e = `${o}-input`, be = {};
