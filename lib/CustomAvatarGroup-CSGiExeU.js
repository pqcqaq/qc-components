import { inject as ie, provide as se, defineComponent as _, shallowRef as T, computed as E, watch as H, nextTick as N, onMounted as ce, createVNode as f, ref as ue, Fragment as X, watchEffect as pe, openBlock as O, createElementBlock as I, unref as W, normalizeProps as de, guardReactiveProps as ge, withCtx as L, renderList as ve, createBlock as me, mergeProps as fe, createTextVNode as he, toDisplayString as Se } from "vue";
import { g as V, m as q, d as m, r as K, u as G, bh as xe, bi as ye, bj as be, U, bk as $e, j as C, P as Ce, bl as Pe, bm as ze, bn as ke, w as we, i as Be, bo as Te, l as Ae, h as _e, T as Re, bp as Me, O as Ne, bq as Oe, $ as D, ac as F, ak as Ee, aM as Ge } from "./index--A0P2N-L.js";
const je = (e) => {
  const {
    antCls: t,
    componentCls: r,
  ...
  setup(e, t) {
    ...
    const n = T(!0), d = T(!1), l = T(1), u = T(null), g = T(null), {
      prefixCls: p
    } = G("avatar", e), [c, y] = Z(p), i = Ie(), a = E(() => e.size === "default" ? i.size : e.size), S = xe(), v = ye(() => {
    ...
    return H(() => e.src, () => {
      ...
      const {
        ...
        draggable: ee,
        crossOrigin: te
      } = e, oe = (s = i.shape) !== null && s !== void 0 ? s : z, w = U(r, e, "icon"), P = p.value, re = {
        [`${o.class}`]: !!o.class,
        [P]: !0,
        [`${P}-lg`]: a.value === "large",
        [`${P}-sm`]: a.value === "small",
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: l,
      configProvider: u
    } = G("popover", e), [g, p] = Ve(l), c = E(() => u.getPrefixCls()), y = () => {
      var i, a;
      const {
  ...
  setup(e, t) {
    ...
    const {
      prefixCls: n,
      direction: d
    } = G("avatar", e), l = E(() => `${n.value}-group`), [u, g] = Z(n);
    return pe(() => {
      const p = {
        size: e.size,
        shape: e.shape
...
const Ye = /* @__PURE__ */ _({
  ...
  setup(e) {
    const t = e;
    return (r, o) => (O(), I("div", null, [
      f(W(A), de(ge(t.groupProps)), {
        default: L(() => [
          (O(!0), I(X, null, ve(t.avatarGroupValue, (n) => (O(), me(W(k), fe({
            key: n.key,
            ref_for: !0
          }, t.avatarProps, {
            src: n.src
