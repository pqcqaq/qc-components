import { g as pe, h as U, n as he, e as ze, _ as E, ai as Y, ae as _e, k as ke, aj as Pe, P as se, u as Ge, F as Ke, A as We, c as Ue, ac as Xe, d as Ye, az as qe, ad as Je, b1 as Qe, D as Ne, s as fe, b as Ze, f as et } from "./index-DELjRDde.js";
...
import { u as at, L as it, T as st, f as ut, i as Le, h as Se, b as rt, j as ct, k as dt, t as ft, B as vt, d as mt, e as pt, g as ht } from "./index-fYbwpAGI.js";
import { K as W } from "./KeyCode-n3eOOGSl.js";
import { p as bt } from "./pickAttrs-DTpYtexn.js";
import { u as gt } from "./move-9QmlZroY.js";
import { o as be } from "./omit-CP-pNPup.js";
import { u as Ee } from "./useMergedState-6HyZ0xMy.js";
import { g as yt, a as St } from "./statusUtils-CivWhTWh.js";
function Ot() {
...
function At(e) {
  ...
  if (Y(c !== "tags" || X.every((k) => !k.disabled), "Please avoid setting option to disabled in tags mode since user can always type text as tag."), Y(c !== "combobox" || !C, "`combobox` mode not support `optionLabelProp`. Please set `value` on Option directly."), Y(c === "combobox" || !n, "`backfill` only works with `combobox` mode."), Y(c === "combobox" || !d, "`getInputElement` only work with `combobox` mode."), _e(c !== "combobox" || !d || !u || !v, "Customize `getInputElement` should customize clear and placeholder logic instead of configuring `allowClear` and `placeholder`."), y && !D && c !== "combobox" && c !== "tags" && Y(!1, "`onSearch` should work with `showSearch` instead of use alone."), _e(!p || O, "`defaultOpen` makes Select open without focus which means it will not close by click outside. You can set `autofocus` if needed."), I != null) {
    const k = Ce(I);
    Y(!F || k.every((V) => typeof V == "object" && ("key" in V || "value" in V)), "`value` should in shape of `{ value: string | number, label?: any }` when you set `labelInValue` to `true`"), Y(!x || Array.isArray(I), "`value` should be array when `mode` is `multiple` or `tags`");
  }
  if (l) {
    let k = null;
    l.some((V) => {
      ...
      return b.isSelectOption ? !1 : b.isSelectOptGroup ? !(((o = V.children) === null || o === void 0 ? void 0 : o.default()) || []).every((P) => !he(P) || !V.type || P.type.isSelectOption ? !0 : (k = P.type, !1)) : (k = b, !0);
    }), k && Y(!1, `\`children\` should be \`Select.Option\` or \`Select.OptGroup\` instead of \`${k.displayName || k.name || k}\`.`), Y(w === void 0, "`inputValue` is deprecated, please use `searchValue` instead.");
  }
}
function ge(e, c) {
...
const Mt = Oe({
  ...
  setup(e, c) {
    ...
    const u = rt(Q(e, "id")), v = S(() => Le(e.mode)), d = S(() => !!(!e.options && e.children)), m = S(() => e.filterOption === void 0 && e.mode === "combobox" ? !1 : e.filterOption), y = S(() => ct(e.fieldNames, d.value)), [p, O] = Ee("", {
      ...
      var r, s;
      let A, J, j, ae;
      kt(i) ? A = i : (j = i.key, J = i.label, A = (r = i.value) !== null && r !== void 0 ? r : j);
...
const Tt = () => E(E({}, be($e(), ["inputIcon", "mode", "getInputElement", "getRawInputElement", "backfill"])), {
  ...
  status: fe(),
  "onUpdate:value": et()
}), De = "SECRET_COMBOBOX_MODE_DO_NOT_USE", q = Oe({
  compatConfig: {
    MODE: 3
  },
  name: "ASelect",
  ...
  setup(e, c) {
    ...
    }), [ue, G] = pt(w), R = S(() => k()), re = S(() => e.placement !== void 0 ? e.placement : C.value === "rtl" ? "bottomRight" : "bottomLeft"), L = S(() => qe(R.value, Je(re.value), e.transitionName)), Z = S(() => pe({
