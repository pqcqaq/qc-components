import { defineComponent as Ie, provide as ht, computed as N, inject as yt, shallowRef as H, createVNode as _, getCurrentInstance as Dn, reactive as Zt, onMounted as pt, onUpdated as Pn, ref as Pe, watchEffect as De, watch as we, nextTick as gt, onBeforeUnmount as Tn, Transition as In, withDirectives as $n, vShow as Ln, Fragment as An, toRaw as xe, onUnmounted as _n, cloneVNode as Fn, toRef as Ge, toRefs as Vn, openBlock as Mn, createBlock as jn, unref as Bn, mergeProps as Hn } from "vue";
import { P as me, Z as ie, _ as w, $ as Jt, h as re, g as Oe, a3 as Qt, ac as en, H as Ye, ad as Rn, a1 as Wn, k as mt, K as be, I as at, L as zn, n as Un, m as bt, ae as Ot, r as Gn, U as qn, i as Xn, A as lt, u as Yn, F as Zn, c as Jn, af as Qn, d as ea, ag as ta, e as na, s as rt, b as aa, C as oa, D as la, f as it } from "./index-Dn-f9Oyw.js";
import { u as ra } from "./move-CRSFmnYB.js";
import { L as ia, u as sa, a as ca, b as da, c as ua, t as Dt, B as fa, d as va, e as ha, g as ya } from "./index-Cc-Obtf2.js";
import { e as Ee } from "./eagerComputed-B06AqR4q.js";
import { u as Pt } from "./useMergedState-6HyZ0xMy.js";
import { g as pa, a as ga } from "./statusUtils-DzHmGpQr.js";
import { g as ma } from "./index-DXHIYLcU.js";
...
}), St = () => yt(tn, N(() => ({}))), nn = Symbol("KeysStateKey"), Sa = (e) => {
  ht(nn, e);
}, an = () => yt(nn, {
  expandedKeys: H([]),
  selectedKeys: H([]),
...
const Tt = "open", It = "close", Ka = "---", $t = Ie({
  compatConfig: {
    MODE: 3
  },
  name: "ATreeNode",
  ...
  setup(e, t) {
    ...
    }), fe = N(() => oe.value ? null : C.value ? Tt : It), ce = N(() => {
      const {
        disabled: c
      } = e, {
        disabled: y
    ...
    const Ue = () => {
      ...
      const O = Oe(`${c}-switcher`, `${c}-switcher_${C.value ? Tt : It}`);
      return y !== !1 ? _("span", {
        onClick: Ae,
        class: O
      }, [y]) : null;
...
function Lt(e, t, n, a, o, r, l, s, u, i) {
  var d;
  const {
    clientX: v,
    clientY: m
...
const Fa = Ie({
  ...
  setup(e, t) {
    ...
    const o = H(!0), r = St(), l = H(!1), s = N(() => e.motion ? e.motion : Wn()), u = (i, d) => {
      var v, m, b, x;
    ...
    return we(() => e.motionNodes, () => {
      e.motionNodes && e.motionType === "hide" && o.value && gt(() => {
        o.value = !1;
      });
    }, {
      immediate: !0,
      ...
      const {
        ...
        active: m,
        eventKey: b
      } = e, x = Ft(e, ["motion", "motionNodes", "motionType", "active", "eventKey"]);
      return d ? _(In, re(re({}, s.value), {}, {
        ...
        default: () => [$n(_("div", {
          ...
          return delete k.children, _($t, re(re({}, k), {}, {
            title: C,
            active: m,
            data: p.data,
            key: I,
  ...
  setup(e, t) {
      ...
      if (S.key !== null) {
        ...
        if (S.add) {
          const F = $.findIndex((ae) => {
            ...
            return oe === S.key;
          }), Q = Ht(Vt($, I, S.key), M, B, L), Z = $.slice();
          Z.splice(F + 1, 0, Bt), u.value = Z, i.value = Q, d.value = "show";
        } else {
          const F = I.findIndex((ae) => {
            ...
            return oe === S.key;
          }), Q = Ht(Vt(I, $, S.key), M, B, L), Z = I.slice();
          Z.splice(F + 1, 0, Bt), u.value = Z, i.value = Q, d.value = "hide";
        }
      } else
        $ !== I && (u.value = I);
    ...
    return () => {
      const p = w(w({}, e), a), {
        ...
        onListChangeEnd: ge
      } = p, de = Mt(p, ["prefixCls", "selectable", "checkable", "disabled", "motion", "height", "itemHeight", "virtual", "focusable", "activeItem", "focused", "tabindex", "onKeydown", "onFocus", "onBlur", "onListChangeStart", "onListChangeEnd"]);
      return _(An, null, [Q && F && _("span", {
        ...
        onVisibleChange: (J, ue) => {
          const ee = new Set(J);
          ue.filter((se) => !ee.has(se)).some((se) => Rt(se) === qe) && v();
        }
      }), {
        default: (J) => {
          const {
...
const Ra = 10, Wa = Ie({
  ...
  setup(e, t) {
    ...
    const r = H(!1);
    let l = {};
    const s = H(), u = H([]), i = H([]), d = H([]), v = H([]), m = H([]), b = H([]), x = {}, p = Zt({
    ...
    const C = H({}), I = H(!1), T = H(null), $ = H(!1), S = N(() => kt(e.fieldNames)), M = H();
    ...
    we(
      ...
      (f, h) => {
        ...
        if (e.expandedKeys !== void 0 || de && K !== P)
          E = e.autoExpandParent || !de && e.defaultExpandParent ? _t(e.expandedKeys, C.value) : e.expandedKeys;
        else if (!de && e.defaultExpandAll) {
          const R = w({}, C.value);
          delete R[qe], E = Object.keys(R).map((q) => R[q].key);
        } else
          !de && e.defaultExpandedKeys && (E = e.autoExpandParent || e.defaultExpandParent ? _t(e.defaultExpandedKeys, C.value) : e.defaultExpandedKeys);
        E && (b.value = E), de = !0;
      },
      {
        immediate: !0
    ...
    De(() => {
      ...
      e.selectable && (e.selectedKeys !== void 0 ? u.value = At(e.selectedKeys, e) : !de && e.defaultSelectedKeys && (u.value = At(e.defaultSelectedKeys, e)));
    });
    const {
      maxLevel: ue,
      levelEntities: ee
    ...
    const he = (f) => {
      ...
      const {
        ...
        dropAllowed: Ce,
        dragOverNodeKey: ke
      } = Lt(f, L, h, s.value, B, A, J.value, C.value, Z.value, P);
      if (
      ...
      const {
        ...
        dropTargetPos: X,
        dragOverNodeKey: Y
      } = Lt(f, L, h, s.value, B, K, J.value, C.value, Z.value, A);
...
xt.displayName = "MinusSquareOutlined";
xt.inheritAttrs = !1;
...
Kt.displayName = "PlusSquareOutlined";
Kt.inheritAttrs = !1;
...
Nt.displayName = "CaretDownFilled";
Nt.inheritAttrs = !1;
...
const eo = new qn("ant-tree-node-fx-do-not-use", {
  ...
  return {
    [n]: w(w({}, Gn(t)), {
      ...
      [`&-focused:not(:hover):not(${n}-active-focused)`]: w({}, Ot(t)),
      // =================== Virtual List ===================
      [`${n}-list-holder-inner`]: {
      ...
      [`${a}`]: {
        ...
        [`&-active ${n}-node-content-wrapper`]: w({}, Ot(t)),
  ...
  const n = `.${e}`, a = `${n}-treenode`, o = t.paddingXS / 2, r = t.controlHeightSM, l = bt(t, {
    treeCls: n,
    treeNodeCls: a,
    treeNodePadding: o,
    treeTitleHeight: r
...
}), vo = "SHOW_ALL", vn = "SHOW_PARENT", Et = "SHOW_CHILD";
function qt(e, t, n, a) {
  const o = new Set(e);
  return t === Et ? e.filter((r) => {
    const l = n[r];
...
const No = Ie({
  ...
  setup(e, t) {
    ...
    const d = N(() => ro(e.fieldNames)), [v, m] = Pt("", {
    ...
    const Z = N(() => F.value.map((D) => D.value)), {
      ...
      const U = qt(fe.value, e.showCheckedStrategy, p.value, d.value).map((O) => {
        var V, G, te;
      ...
      if (B(c), e.autoClearSearchValue && m(""), e.onChange) {
        let y = D;
        l.value && (y = qt(D, e.showCheckedStrategy, p.value, d.value).map((A) => {
...
const ct = Ie({
  ...
  setup(e, t) {
    ...
    }), B = N(() => k()), L = N(() => e.placement !== void 0 ? e.placement : v.value === "rtl" ? "bottomRight" : "bottomLeft"), F = N(() => Xt(B.value, ta(L.value), e.transitionName)), Q = N(() => Xt(B.value, "", e.choiceTransitionName)), Z = N(() => k("select-tree", e.prefixCls)), ae = N(() => k("tree-select", e.prefixCls)), [oe, fe] = ha(i), [ce] = Oo(ae, Z), ge = N(() => Oe(e.popupClassName || e.dropdownClassName, `${ae.value}-dropdown`, {
  ...
  SHOW_PARENT: vn,
  SHOW_CHILD: Et,
  install: (e) => (e.component(ct.name, ct), e.component(Yt.displayName, Yt), e)
}), Mo = /* @__PURE__ */ Ie({
