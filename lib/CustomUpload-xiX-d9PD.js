...
import { K as kt, M as Nt, N as zt, O as Bt, s as B, f as _, b as z, Q as je, E as G, D as K, A as Q, R as Fe, _ as D, h as F, k as ie, T as mt, i as vt, m as ht, r as yt, S as Le, c as be, U as Ht, C as Wt, V as Xt, j as Vt, I as te, X as Gt, a as ve, Y as qt, Z as Yt, $ as Jt, a0 as Qt, L as Re, n as Zt, a1 as Te, a2 as bt, a3 as wt, z as Kt, a4 as en, u as tn, d as nn, a5 as rn, a6 as on, g as ae, e as ln, a7 as Pe, a8 as an } from "./index-DELjRDde.js";
import { P as sn } from "./PlusOutlined-BTbOfnTF.js";
import { p as cn } from "./pickAttrs-DTpYtexn.js";
import { E as un } from "./EyeOutlined-CIx2kb3r.js";
import { C as dn } from "./CheckOutlined-BPK3BRik.js";
...
const $r = () => ({
  ...
  setup(e, t) {
    ...
    const {
      rootPrefixCls: u
    } = be("upload", e), b = R(() => qt(`${u.value}-fade`));
    return () => {
      var p, O;
      const {
        prefixCls: h,
  ...
  setup(e, t) {
    ...
    const {
      ...
      const l = D({}, Yt(`${h.value}-motion-collapse`));
      delete l.onAfterAppear, delete l.onAfterEnter, delete l.onAfterLeave;
      const g = D(D({}, Jt(`${O.value}-${e.listType === "picture-card" ? "animate-inline" : "animate"}`)), {
        class: d.value,
        appear: o.value
      });
    ...
    [`${t}-wrapper${t}-picture-card-wrapper`]: D(D({}, wt()), {
      ...
      [`${a}${a}-picture-card`]: {
        ...
        [`${i}-actions, ${i}-actions:hover`]: {
          [`${n}-eye, ${n}-download, ${n}-delete`]: {
            color: new Kt(o).setAlpha(0.65).toRgbString(),
            "&:hover": {
              color: o
            }
          }
  ...
  return [Rr(s), Pr(s), _r(s), Dr(s), xr(s), Ir(s), Fr(s), en(s)];
});
...
const se = `__LIST_IGNORE_${Date.now()}__`, ge = H({
  ...
  setup(e, t) {
    ...
    const [U] = rn("Upload", on.Upload, R(() => e.locale)), N = (m, $) => {
      const {
        removeIcon: C,
        previewIcon: S,
        downloadIcon: I,
    ...
    return () => {
      ...
      const ne = ae(i.value, {
        ...
        [`${i.value}-disabled`]: h.value,
        [`${i.value}-rtl`]: s.value === "rtl"
      }), X = ln((C = n.default) === null || C === void 0 ? void 0 : C.call(n)), V = (Y) => c("div", {
        class: ne,
        style: Y
      }, [c(et, F(F({}, M), {}, {
        ref: g
        ...
        default: Se(() => [
          oe("div", Br, [
            ...
            n.uploadType == "Image" ? (re(), Ve("div", Wr, [
              oe("div", null, [
                i.value ? (re(), ue(de(Re), { key: 0 })) : (re(), ue(de(sn), { key: 1 })),
...
}), oo = /* @__PURE__ */ an(Yr, [["__scopeId", "data-v-13425e11"]]);
export {
  oo as default
};
