import { defineComponent as y, computed as S, onBeforeMount as L, ref as f, watch as A, onMounted as O, nextTick as V, createVNode as h, openBlock as W, createBlock as X, unref as j, mergeProps as K } from "vue";
import { i as R, m as N, z as U, _ as w, r as G, H as J, j as Q, J as q, u as Y, d as Z, w as C, c as k, W as ii, h as I, L as ni, K as b, P as a } from "./index-DGUz0BTe.js";
import { K as x } from "./KeyCode-n3eOOGSl.js";
import { o as ei } from "./omit-COyW2GJT.js";
const ci = (i) => {
  const {
    componentCls: n
  } = i, e = `${n}-inner`;
  ...
  const n = i.fontSize * i.lineHeight, e = i.controlHeight / 2, d = 2, r = n - d * 2, t = e - d * 2, s = N(i, {
    switchMinWidth: r * 2 + d * 4,
    switchHeight: n,
    ...
    switchInnerMarginMax: r + d + d * 2,
    switchPadding: d,
    switchPinSize: r,
    switchBg: i.colorBgContainer,
    switchMinWidthSM: t * 2 + d * 2,
    switchHeightSM: e,
    switchInnerMarginMinSM: t / 2,
    switchInnerMarginMaxSM: t + d + d * 2,
    switchPinSizeSM: t,
  ...
  setup(i, n) {
    ...
    const p = (c, o) => {
      ...
      [`${l.value}-small`]: z.value === "small",
      [`${l.value}-loading`]: i.loading,
      [`${l.value}-checked`]: M.value,
      [`${l.value}-disabled`]: g.value,
      [l.value]: !0,
      [`${l.value}-rtl`]: P.value === "rtl",
      [E.value]: !0
    }));
    return () => {
      var c;
      return H(h(ii, null, {
        default: () => [h("button", I(I(I({}, ei(i, ["prefixCls", "checkedChildren", "unCheckedChildren", "checked", "autofocus", "checkedValue", "unCheckedValue", "id", "onChange", "onUpdate:checked"])), e), {}, {
        ...
        }, [b(d, i, "checkedChildren")]), h("span", {
          class: `${l.value}-inner-unchecked`
        }, [b(d, i, "unCheckedChildren")])])])]
      }));
    };
  }
}), ui = Q(hi), pi = /* @__PURE__ */ y({
  __name: "CustomSwitch",
  props: {
    value: { type: Boolean }
  },
