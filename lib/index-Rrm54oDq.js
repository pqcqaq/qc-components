import { I as tt, f as M, g as j, h as R, Y as nt, y as Re, _ as v, b as B, E as Y, s as ye, i as rt, al as at, r as Ae, b1 as it, u as lt, F as ot, c as st, ad as ut, d as dt, a_ as Ve, a$ as Te, ah as ct, P as be } from "./index-DGUz0BTe.js";
import { createVNode as b, defineComponent as Ie, ref as We, onBeforeUnmount as He, shallowRef as O, computed as W, watch as J } from "vue";
import { i as ft, D as pt } from "./DownOutlined-CTjAdqQv.js";
import { K as le } from "./KeyCode-n3eOOGSl.js";
import { o as mt } from "./omit-COyW2GJT.js";
import { g as gt, a as Se } from "./statusUtils-FU9aJEap.js";
import { i as vt, b as Ge, c as Le, a as Ue, g as ht, d as bt, f as St, e as $t } from "./index-CrosLSpq.js";
...
class z {
  ...
  add(t) {
    ...
    const i = Math.max(Z(this.number), Z(n));
...
class U {
  ...
  toString() {
    return (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0) ? this.isInvalidate() ? "" : Q(`${this.getMark()}${this.getIntegerStr()}.${this.getDecimalStr()}`).fullStr : this.origin;
  }
}
function P(e) {
...
const Be = (e, t) => e || t.isEmpty() ? t.toString() : t.toNumber(), ze = (e) => {
  ...
  stringMode: B(),
  defaultValue: Y([String, Number]),
  value: Y([String, Number]),
  prefixCls: ye(),
  min: Y([String, Number]),
  max: Y([String, Number]),
  step: Y([String, Number], 1),
  tabindex: Number,
  controls: B(!0),
  readonly: B(),
  disabled: B(),
  ...
  setup(e, t) {
    ...
    const y = W(() => ze(e.max)), N = W(() => ze(e.min)), A = W(() => !y.value || !s.value || s.value.isInvalidate() ? !1 : y.value.lessEquals(s.value)), V = W(() => !N.value || !s.value || s.value.isInvalidate() ? !1 : s.value.lessEquals(N.value)), [q, ee] = Et(d, p), oe = (r) => y.value && !r.lessEquals(y.value) ? y.value : N.value && !N.value.lessEquals(r) ? N.value : null, te = (r) => !oe(r), k = (r, o) => {
      var u;
      let m = r, x = te(m) || m.isEmpty();
      if (!m.isEmpty() && !o && (m = oe(m) || m, x = !0), !e.readonly && !e.disabled && x) {
        const D = m.toString(), G = w(D, o);
        return G >= 0 && (m = P(xe(D, ".", G))), m.equals(s.value) || ($(m), (u = e.onChange) === null || u === void 0 || u.call(e, m.isEmpty() ? null : Be(e.stringMode, m)), e.value === void 0 && _(m, o)), m;
      }
      return s.value;
    }, se = Ct(), h = (r) => {
      var o;
      ...
      let m = P(e.step);
      r || (m = m.negate());
      const x = (s.value || P(0)).add(m.toString()), D = k(x, !1);
      (o = e.onStep) === null || o === void 0 || o.call(e, Be(e.stringMode, D), {
        offset: e.step,
        type: r ? "up" : "down"
      ...
      const o = P(I(S.value));
      let u = o;
      o.isNaN() ? u = s.value : u = k(o, r), e.value !== void 0 ? _(s.value, !1) : u.isNaN() || _(u, !1);
    }, ue = (r) => {
      var o;
      const {
        which: u
    ...
    return J(() => e.precision, () => {
      s.value.isInvalidate() || _(s.value, !1);
    }, {
      flush: "post"
    }), J(() => e.value, () => {
      const r = P(e.value);
      s.value = r;
      const o = P(I(S.value));
      (!r.equals(o) || !f.value || e.formatter) && _(r, f.value);
    }, {
      flush: "post"
    }), J(S, () => {
      e.formatter && ee();
      ...
      const r = v(v({}, n), e), {
        ...
        class: Xe,
        style: Ye
      } = r, Je = Pt(r, ["prefixCls", "min", "max", "step", "defaultValue", "value", "disabled", "readonly", "keyboard", "controls", "autofocus", "stringMode", "parser", "formatter", "precision", "decimalSeparator", "onChange", "onInput", "onPressEnter", "onStep", "lazy", "class", "style"]), {
        upHandler: Qe,
        downHandler: Ze
      } = a, Me = `${o}-input`, he = {};
...
const _t = (e) => {
  ...
  return {
    [`${t}-affix-wrapper`]: v(v(v({}, Ge(e)), Le(e, `${t}-affix-wrapper`)), {
...
const je = ke(), At = () => v(v({}, je), {
  ...
  setup(e, t) {
    ...
    const d = lt(), p = ot.useInject(), f = W(() => gt(p.status, e.status)), {
      prefixCls: c,
      size: s,
      direction: $,
      disabled: w
    ...
    }), [_, y] = Mt(c), N = W(() => I.value || s.value), A = O(e.value === void 0 ? e.defaultValue : e.value), V = O(!1);
    J(() => e.value, () => {
      A.value = e.value;
    });
    const q = O(null), ee = () => {
    ...
    return () => {
      ...
      const {
        ...
        addonAfter: D = (X = l.addonAfter) === null || X === void 0 ? void 0 : X.call(l),
        prefix: G = (H = l.prefix) === null || H === void 0 ? void 0 : H.call(l),
        valueModifiers: ae = {}
      ...
      let F = b(Ot, R(R({}, mt(ie, ["size", "defaultValue"])), {}, {
        ref: q,
        lazy: !!ae.lazy,
        value: A.value,
        class: ce,
      ...
      if (fe) {
        const L = `${g}-group`, me = `${L}-addon`, ge = x ? b("div", {
          ...
          class: me
        }, [D]) : null, _e = j(`${g}-wrapper`, L, {
          [`${L}-rtl`]: $.value === "rtl"
        }, y.value), De = j(`${g}-group-wrapper`, {
