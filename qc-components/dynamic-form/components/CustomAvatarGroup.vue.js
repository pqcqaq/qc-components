...
function __VLS_template() {
    ...
    for (const [option] of __VLS_getVForSourceType((props.avatarGroupValue))) {
        const __VLS_5 = {}.Avatar;
        const __VLS_6 = __VLS_asFunctionalComponent(__VLS_5, new __VLS_5({ key: ((option.key)), ...(props.avatarProps), src: ((option.src)), }));
        ({}.Avatar);
        ({}.Avatar);
        ...
        // @ts-ignore
        [Avatar, Avatar,];
        const __VLS_7 = __VLS_6({ key: ((option.key)), ...(props.avatarProps), src: ((option.src)), }, ...__VLS_functionalComponentArgsRest(__VLS_6));
