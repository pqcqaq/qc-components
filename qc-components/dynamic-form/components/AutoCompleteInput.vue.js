...
function __VLS_template() {
    ...
    let __VLS_5 = { 'select': __VLS_pickEvent(__VLS_3['select'], {}.onSelect) };
    __VLS_5 = { select: (__VLS_ctx.handleSelect) };
    let __VLS_6 = { 'search': __VLS_pickEvent(__VLS_3['search'], {}.onSearch) };
    __VLS_6 = { search: (__VLS_ctx.onSearch) };
    // @ts-ignore
