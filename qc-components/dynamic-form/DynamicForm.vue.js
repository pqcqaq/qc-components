...
export default await (async () => {
    ...
    function __VLS_template() {
        ...
        // @ts-ignore
        [AForm, AForm,];
        const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ref: ("formRef"), model: ((__VLS_ctx.formModel)), ...({ ...__VLS_ctx.$attrs, ...props.schema.formProps }), disabled: ((__VLS_ctx.loading || props.disabled)), ...{ class: ((props.schema.className || 'dynamic-form')) }, }));
        const __VLS_2 = __VLS_1({ ref: ("formRef"), model: ((__VLS_ctx.formModel)), ...({ ...__VLS_ctx.$attrs, ...props.schema.formProps }), disabled: ((__VLS_ctx.loading || props.disabled)), ...{ class: ((props.schema.className || 'dynamic-form')) }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
        ({}({ ref: ("formRef"), model: ((__VLS_ctx.formModel)), ...({ ...__VLS_ctx.$attrs, ...props.schema.formProps }), disabled: ((__VLS_ctx.loading || props.disabled)), ...{ class: ((props.schema.className || 'dynamic-form')) }, }));
